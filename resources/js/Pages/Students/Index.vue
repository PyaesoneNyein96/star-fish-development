...
onMounted(() => {
    const tableRef = document.querySelector('#studentTable');
    const dataTable = new simpleDatatables.DataTable(tableRef);
...
<template>
    ...
    <main id="main" class="main">
        <div class=" mx-3 ">
            ...
            <table id="studentTable" class="table table-hover rounded-5">
                <thead>
                    <tr class=" ">
                        <th>id</th>
                        <th>Photo</th>
