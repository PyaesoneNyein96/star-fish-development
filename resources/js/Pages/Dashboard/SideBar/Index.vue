...
onMounted(() => {
    ...
    currentUrl.includes("/dashboard/profile")
        ...
        : currentUrl.includes("/dashboard/students")
            ? $("#students").removeClass("collapsed")
            : currentUrl.includes("/dashboard/rewards")
                ? $("#rewards").removeClass("collapsed")
                : currentUrl.includes("/dashboard/chats")
                    ? $("#chats").removeClass("collapsed")
...
<aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <!-- <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" id="profile" @click="toProfile">
