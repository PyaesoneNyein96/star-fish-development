...
class AnsNQueSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 12, 'a_content' => 'https://player.vimeo.com/video/943657484', 'isLocal' => 1]);
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 13, 'a_image' => $l3G13image . "susan.gif", "a_audio" => $AudioDomain . $G1_L3_read_listen_and_practice_path . "helloiamsusan.mp3", "a_conver" => $l3G13image .  "susan-hello.png", "background" =>  $l3G13image . "bg.png"],
            ['round' => 1, 'game_id' => 13, 'a_image' => $l3G13image . "mary.gif", "a_audio" => $AudioDomain . $G1_L3_read_listen_and_practice_path . "merry_nicetomeetyou.mp3", "a_conver" => $l3G13image .  "nice-to.png", "background" =>  $l3G13image . "bg.png"],

            ['round' => 2, 'game_id' => 13, 'a_image' => $l3G13image . "mary.gif", "a_audio" => $AudioDomain . $G1_L3_read_listen_and_practice_path . "helloiammerry.mp3", "a_conver" => $l3G13image .  "mary-hello.png", "background" =>  $l3G13image . "bg.png"],
        ...
        for ($i = 0; $i < count($converG15); $i++) {
            ...
            for ($j = 0; $j < count($converG15[$i]); $j++) {
                ...
                DB::table('ans_n_ques')->insert([
                    ['round' => $G15Id, 'game_id' => 14, 'a_conver' => $l3G14image . $converG15[$i][$j] . ".png", 'a_image' => $l3G14image . $imageG15[$i][$j] . ".gif", 'a_audio' => $AudioDomain . $G1_L3_listen_and_practice_path . $audiosG15[$i][$j] . ".mp3", "background" => $l3G14image . "background.png"],
                ]);
            }
            $G15Id++;
        }
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 16, "q_audio" =>  $AudioDomain . $G1_L3_Speaking . "SubBlock_Hello-Im-Bowie-Nice-to-meet" . ".mp3", 'q_image' => $l3G16image . "Orange_Vector_round.png", "q_content" => "Hello, I'm ___ . Nice to meet you."],
            ['round' => 2, 'game_id' => 16, "q_audio" =>  $AudioDomain . $G1_L3_Speaking . "SubBlock_Hi-Im-Kelly-Nice-to-meet-you" . ".mp3", 'q_image' => $l3G16image . "Green_Vector_round.png", "q_content" => "Hi, I'm ___ . Nice to meet you."],
        ]);
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 17, 'a_content' => 'https://player.vimeo.com/video/943658164', 'isLocal' => 1]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 3, 'game_id' => 18, 'a_image' => $l4image . "dory.gif", "a_audio" => $AudioDomain . $G1_L4_Read_Listen_n_Repeat_path . "Whats-your-name.mp3", "a_conver" =>  $l4image . "q-right.png", "background" =>  $l4image . "bg1.png"],
            ['round' => 3, 'game_id' => 18, 'a_image' => $l4image . "nemo.gif", "a_audio" => $AudioDomain . $G1_L4_Read_Listen_n_Repeat_path . "My-names-Nemo.mp3", "a_conver" =>  $l4image . "nemo-text.png", "background" =>  $l4image . "bg1.png"],

            ['round' => 4, 'game_id' => 18, 'a_image' => $l4image . "nemo.gif", "a_audio" => $AudioDomain . $G1_L4_Read_Listen_n_Repeat_path . "SubBlock_Whats-your-name_nemo.mp3", "a_conver" =>  $l4image . "q-right.png", "background" =>  $l4image . "bg1.png"],
            ['round' => 4, 'game_id' => 18, 'a_image' => $l4image . "dory.gif", "a_audio" => $AudioDomain . $G1_L4_Read_Listen_n_Repeat_path . "My-names-Dory.mp3", "a_conver" =>  $l4image . "dory-text.png", "background" =>  $l4image . "bg1.png"],
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 19, 'q_image' => $l4image . "bowie.png", "q_audio" => $AudioDomain . $G1_L4_Read_Listen_n_Repeat_path . "SubBlock_My-names-Bowie.mp3", "q_conver" => $l4image . "name-bowie.png", "q_content" => "What's your name?"],
            ['round' => 2, 'game_id' => 19, 'q_image' => $l4image . "kelly.png", "q_audio" => $AudioDomain . $G1_L4_Read_Listen_n_Repeat_path . "SubBlock_My-names-kelly.mp3",  "q_conver" => $l4image . "name-kelly.png", "q_content" => "What's your name?"],
            ['round' => 3, 'game_id' => 19, 'q_image' => $l4image . "goldie.png", "q_audio" => $AudioDomain . $G1_L4_Read_Listen_n_Repeat_path . "SubBlock_My-names-Goldie.mp3",  "q_conver" => $l4image . "name-goldie.png", "q_content" => "What's your name?"],
            ['round' => 4, 'game_id' => 19, 'q_image' => $l4image . "blu.png", "q_audio" => $AudioDomain . $G1_L4_Read_Listen_n_Repeat_path . "SubBlock_My-names-Blu.mp3",  "q_conver" => $l4image . "name-blu.png", "q_content" => "What's your name?"],
        ]);
        ...
        $G1_L4_writing = "Grade_1/" . "Lesson_4/" . "writing/";
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 21, 'a_content' => "What's your name ? My name's Dory.", 'a_audio' =>  $AudioDomain . $G1_L4_writing . "My-name's-dory-for-Writing.mp3"],
        ]);
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 2, 'game_id' => 21, 'a_content' => "What is your name ? My name is Susan.", 'a_audio' =>   $AudioDomain . $G1_L4_writing . "My-name's-Susan-for-Writing.mp3"],
        ]);
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 3, 'game_id' => 21, 'a_content' => "What's your name ? My name's Chris.", 'a_audio' =>  $AudioDomain . $G1_L4_writing . "My-name's-Chris-for-Writing.mp3"],
        ]);
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 4, 'game_id' => 21, 'a_content' => "What is your name ? My name is Mary.", 'a_audio' =>  $AudioDomain . $G1_L4_writing . "My-name's-Mary-for-Writing.mp3"],
        ]);
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 22, 'a_content' => 'https://player.vimeo.com/video/943666848', 'isLocal' => 1]);
        ...
        DB::table('ans_n_ques')->insert([
            ["round" => 1, "game_id" => 24, "a_image" => $l5G24image . "boy.gif", "a_audio" => $AudioDomain . $G1_L5_G24_read_listen_n_repeat_path . "Good-morning.mp3", "a_conver" => $l5G24image . "morning-left.png", "background" => $l5G24image . "bg.png"],
            ["round" => 1, "game_id" => 24, "a_image" => $l5G24image . "girl.gif", "a_audio" => $AudioDomain . $G1_L5_G24_read_listen_n_repeat_path . "SubBlock_Good-morning.mp3", "a_conver" => $l5G24image . "morning-right.png", "background" => $l5G24image . "bg.png"],

            ["round" => 2, "game_id" => 24, "a_image" => $l5G24image . "boy.gif", "a_audio" => $AudioDomain . $G1_L5_G24_read_listen_n_repeat_path . "Good-afternoon.mp3", "a_conver" => $l5G24image . "afternoon-left.png", "background" => $l5G24image . "bg.png"],
            ["round" => 2, "game_id" => 24, "a_image" => $l5G24image . "girl.gif", "a_audio" => $AudioDomain . $G1_L5_G24_read_listen_n_repeat_path . "SubBlock_Good-afternoon.mp3", "a_conver" => $l5G24image . "afternoon-right.png", "background" => $l5G24image . "bg.png"],

            ["round" => 3, "game_id" => 24, "a_image" => $l5G24image . "boy.gif", "a_audio" => $AudioDomain . $G1_L5_G24_read_listen_n_repeat_path . "Good-evening.mp3", "a_conver" => $l5G24image . "evening-left.png", "background" => $l5G24image . "bg.png"],
            ["round" => 3, "game_id" => 24, "a_image" => $l5G24image . "girl.gif", "a_audio" => $AudioDomain . $G1_L5_G24_read_listen_n_repeat_path . "SubBlock_Good-evening.mp3", "a_conver" => $l5G24image . "evening-right.png", "background" => $l5G24image . "bg.png"],


            ["round" => 4, "game_id" => 24, "a_image" => $l5G24image . "girl.gif", "a_audio" => $AudioDomain . $G1_L5_G24_read_listen_n_repeat_path . "how_are_you_chris.mp3", "a_conver" => $l5G24image . "chris-right.png", "background" => $l5G24image . "bg.png"],
            ["round" => 4, "game_id" => 24, "a_image" => $l5G24image . "boy.gif", "a_audio" => $AudioDomain . $G1_L5_G24_read_listen_n_repeat_path . "i'm_fine.mp3", "a_conver" => $l5G24image . "fine.png", "background" => $l5G24image . "bg.png"],

            ["round" => 5, "game_id" => 24, "a_image" => $l5G24image . "boy.gif", "a_audio" => $AudioDomain . $G1_L5_G24_read_listen_n_repeat_path . "how_are_you_susan.mp3", "a_conver" => $l5G24image . "susan-left.png", "background" => $l5G24image . "bg.png"],
            ["round" => 5, "game_id" => 24, "a_image" => $l5G24image . "girl.gif", "a_audio" => $AudioDomain . $G1_L5_G24_read_listen_n_repeat_path . "i'm_ok.mp3", "a_conver" => $l5G24image . "ok.png", "background" => $l5G24image . "bg.png"],



            ["round" => 6, "game_id" => 24, "a_image" => $l5G24image . "girl2.gif", "a_audio" => $AudioDomain . $G1_L5_G24_read_listen_n_repeat_path . "good_afternoon_susan.mp3", "a_conver" => $l5G24image . "afternoon-susan.png", "background" => $l5G24image . "bg.png"],
            ["round" => 6, "game_id" => 24, "a_image" => $l5G24image . "girl.gif", "a_audio" => $AudioDomain . $G1_L5_G24_read_listen_n_repeat_path . "good_afternoon_mary.mp3", "a_conver" => $l5G24image . "afternoon-mary.png", "background" => $l5G24image . "bg.png"],

            ["round" => 7, "game_id" => 24, "a_image" => $l5G24image . "girl2.gif", "a_audio" => $AudioDomain . $G1_L5_G24_read_listen_n_repeat_path . "how_are_you.mp3", "a_conver" => $l5G24image . "how-are-you.png", "background" => $l5G24image . "bg.png"],
            ["round" => 7, "game_id" => 24, "a_image" => $l5G24image . "girl.gif", "a_audio" => $AudioDomain . $G1_L5_G24_read_listen_n_repeat_path . "i'm_great_and_you.mp3", "a_conver" => $l5G24image . "great-you.png", "background" => $l5G24image . "bg.png"],


            ["round" => 7, "game_id" => 24, "a_image" => $l5G24image . "girl2.gif", "a_audio" => $AudioDomain . $G1_L5_G24_read_listen_n_repeat_path . "i'm_ok_2.mp3", "a_conver" => $l5G24image . "ok.png", "background" => $l5G24image . "bg.png"],


            ["round" => 8, "game_id" => 24, "a_image" => $l5G24image . "girl2.gif", "a_audio" => $AudioDomain . $G1_L5_G24_read_listen_n_repeat_path . "goodbye.mp3", "a_conver" => $l5G24image . "bye-left.png", "background" => $l5G24image . "bg.png"],
            ["round" => 8, "game_id" => 24, "a_image" => $l5G24image . "girl.gif", "a_audio" => $AudioDomain . $G1_L5_G24_read_listen_n_repeat_path . "goodbye_2.mp3", "a_conver" => $l5G24image . "bye-right.png", "background" => $l5G24image . "bg.png"],
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 25, "q_image" => null, "q_audio" => $AudioDomain . $G1_L5_reading_passage_path . "Hi-my-name-is-Anna-Im-6-yea.mp3", "q_content" => "Anna", 'q_conver' => "Hi, my name is Anna. I'm 6 years old. Early in the morning, I say \"Good morning, Hello and how are you?\" They say \"I'm fine. And you? \"I say \"I'm great.\" It's going to be a wonderful day.", 'a_content' => null, "background" => $l5G25image . "newbg.png"],
            ...
            ['round' => 2, 'game_id' => 25, "q_image" => null, "q_audio" => $AudioDomain . $G1_L5_reading_passage_path . "Hi-my-name-is-Anna-Im-6-yea.mp3", "q_content" => "Anna", 'q_conver' => "Hi, my name is Anna. I'm 6 years old. Early in the morning, I say \"Good morning, Hello and how are you?\" They say \"I'm fine. And you? \"I say \"I'm great.\" It's going to be a wonderful day.",  'a_content' => null, "background" => $l5G25image . "newbg.png"],
            ...
            ['round' => 3, 'game_id' => 25, "q_image" => null, "q_audio" => $AudioDomain . $G1_L5_reading_passage_path . "Hi-my-name-is-Anna-Im-6-yea.mp3", "q_content" => "Anna", 'q_conver' => "Hi, my name is Anna. I'm 6 years old. Early in the morning, I say \"Good morning, Hello and how are you?\" They say \"I'm fine. And you? \"I say \"I'm great.\" It's going to be a wonderful day.", 'a_content' => null, "background" => $l5G25image . "newbg.png"],
            ...
            ['round' => 4, 'game_id' => 25, "q_image" => null, "q_audio" => $AudioDomain . $G1_L5_reading_passage_path . "Hi-my-name-is-Anna-Im-6-yea.mp3", "q_content" => "Anna", 'q_conver' => "Hi, my name is Anna. I'm 6 years old. Early in the morning, I say \"Good morning, Hello and how are you?\" They say \"I'm fine. And you? \"I say \"I'm great.\" It's going to be a wonderful day.", 'a_content' => null, "background" => $l5G25image . "newbg.png"],
        ]);
        ...
        $G1_L5_Speaking = "Grade_1/" . "Lesson_5/" . "Speaking/";

        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 26, "q_audio" =>  $AudioDomain . $G1_L5_Speaking . "Good-evening" . ".mp3", 'q_image' => $l5G26image . "orangestar_round.png", "q_content" => '"Good evening"'],
            ['round' => 2, 'game_id' => 26, "q_audio" =>  $AudioDomain . $G1_L5_Speaking . "Good-afternoon" . ".mp3", 'q_image' => $l5G26image . "orangestar_round.png", "q_content" => '"Good afternoon"'],
            ['round' => 3, 'game_id' => 26, "q_audio" =>  $AudioDomain . $G1_L5_Speaking . "Good-morning" . ".mp3", 'q_image' => $l5G26image . "orangestar_round.png", "q_content" => '"Good morning"'],
            ['round' => 4, 'game_id' => 26, "q_audio" =>  $AudioDomain . $G1_L5_Speaking . "How-are-you" . ".mp3", 'q_image' => $l5G26image . "greenstar_round.png", "q_content" => "How are you?"],
        ...
        $qG27 = [
            ...
            ["Good afternoon, Mike.", "I'm OK.", "GoodBye.", "How are you?", "I'm great.", "And you?"],
        ];
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 28, 'a_content' => 'https://player.vimeo.com/video/943671918', 'isLocal' => 1]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            [
                'round' => 1, 'game_id' => 30, 'a_content' => "crayon", 'q_image' => $l6G30image . "crayon" . ".png",
                'a_audio' => $AudioDomain . $G1_L6_listen_n_practice . "crayon" . ".mp3", "background" => $l6G30image . "background.png"
            ],
            [
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 32, 'q_image' => $l6G32image . "crayon.png", "q_audio" => $AudioDomain . $G1_L6_Speaking . "crayon.mp3", "q_content" => "Look at the picture and say the words. \nWhat's this?", "round_instruction" => $AudioDomain . $G1_L6_Speaking . "Look-at-the-picture-and-say-th.mp3"],
            ['round' => 2, 'game_id' => 32, 'q_image' => $l6G32image . "eraser.png", "q_audio" => $AudioDomain . $G1_L6_Speaking . "eraser.mp3", "q_content" => "Look at the picture and say the words. \nWhat's this?", "round_instruction" => $AudioDomain . $G1_L6_Speaking . "Look-at-the-picture-and-say-th.mp3"],
            ['round' => 3, 'game_id' => 32, 'q_image' => $l6G32image . "pen.png", "q_audio" => $AudioDomain . $G1_L6_Speaking . "pen.mp3", "q_content" => "Look at the picture and say the words. \nWhat's this?", "round_instruction" => $AudioDomain . $G1_L6_Speaking . "Look-at-the-picture-and-say-th.mp3"],
            ['round' => 4, 'game_id' => 32, 'q_image' => $l6G32image . "pencilcase.png", "q_audio" => $AudioDomain . $G1_L6_Speaking . "pencil-case.mp3", "q_content" => "Look at the picture and say the words. \nWhat's this?", "round_instruction" => $AudioDomain . $G1_L6_Speaking . "Look-at-the-picture-and-say-th.mp3"],
            ['round' => 5, 'game_id' => 32, 'q_image' => $l6G32image . "ruler.png", "q_audio" => $AudioDomain . $G1_L6_Speaking . "ruler.mp3", "q_content" => "Look at the picture and say the words. \nWhat's this?", "round_instruction" => $AudioDomain . $G1_L6_Speaking . "Look-at-the-picture-and-say-th.mp3"],
            ['round' => 6, 'game_id' => 32, 'q_image' => $l6G32image . "sharpener.png", "q_audio" => $AudioDomain . $G1_L6_Speaking . "sharpener.mp3", "q_content" => "Look at the picture and say the words. \nWhat's this?", "round_instruction" => $AudioDomain . $G1_L6_Speaking . "Look-at-the-picture-and-say-th.mp3"],
            ['round' => 7, 'game_id' => 32, 'q_image' => $l6G32image . "bag.png", "q_audio" => $AudioDomain . $G1_L6_Speaking . "bag.mp3", "q_content" => "Look at the picture and say the words. \nWhat's this?", "round_instruction" => $AudioDomain . $G1_L6_Speaking . "Look-at-the-picture-and-say-th.mp3"],
            ['round' => 8, 'game_id' => 32, 'q_image' => $l6G32image . "book.png", "q_audio" => $AudioDomain . $G1_L6_Speaking . "book.mp3", "q_content" => "Look at the picture and say the words. \nWhat's this?", "round_instruction" => $AudioDomain . $G1_L6_Speaking . "Look-at-the-picture-and-say-th.mp3"],
        ]);
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 41, 'a_content' => 'https://player.vimeo.com/video/943678375', 'isLocal' => 1]);
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 45, 'q_image' => $l8G45image . "plate.png", "q_audio" => $AudioDomain . $G1_L8_Speaking . "plate.mp3", "round_instruction" => $AudioDomain . $G1_L8_Speaking . "SubBlock_Look-at-the-picture-and-say-a.mp3", "q_content" => "Look at the picture and say a word."],
            ['round' => 2, 'game_id' => 45, 'q_image' => $l8G45image . "spoon.png", "q_audio" => $AudioDomain . $G1_L8_Speaking . "spoon.mp3", "round_instruction" => $AudioDomain . $G1_L8_Speaking . "SubBlock_Look-at-the-picture-and-say-a.mp3", "q_content" => "Look at the picture and say a word."],
            ['round' => 3, 'game_id' => 45, 'q_image' => $l8G45image . "cup.png", "q_audio" => $AudioDomain . $G1_L8_Speaking . "cups.mp3", "round_instruction" => $AudioDomain . $G1_L8_Speaking . "SubBlock_Look-at-the-picture-and-say-a.mp3", "q_content" => "Look at the picture and say a word."],
            ['round' => 4, 'game_id' => 45, 'q_image' => $l8G45image . "table.png", "q_audio" => $AudioDomain . $G1_L8_Speaking . "table.mp3", "round_instruction" => $AudioDomain . $G1_L8_Speaking . "SubBlock_Look-at-the-picture-and-say-a.mp3", "q_content" => "Look at the picture and say a word."],
            ['round' => 5, 'game_id' => 45, 'q_image' => $l8G45image . "clock.png", "q_audio" => $AudioDomain . $G1_L8_Speaking . "clock.mp3", "round_instruction" => $AudioDomain . $G1_L8_Speaking . "SubBlock_Look-at-the-picture-and-say-a.mp3", "q_content" => "Look at the picture and say a word."],
            ['round' => 6, 'game_id' => 45, 'q_image' => $l8G45image . "bottle.png", "q_audio" => $AudioDomain . $G1_L8_Speaking . "bottle.mp3", "round_instruction" => $AudioDomain . $G1_L8_Speaking . "SubBlock_Look-at-the-picture-and-say-a.mp3", "q_content" => "Look at the picture and say a word."],
            ['round' => 7, 'game_id' => 45, 'q_image' => $l8G45image . "apple.png", "q_audio" => $AudioDomain . $G1_L8_Speaking . "apple.mp3", "round_instruction" => $AudioDomain . $G1_L8_Speaking . "SubBlock_Look-at-the-picture-and-say-a.mp3", "q_content" => "Look at the picture and say a word."],
            ['round' => 8, 'game_id' => 45, 'q_image' => $l8G45image . "fan.png", "q_audio" => $AudioDomain . $G1_L8_Speaking . "fan.mp3", "round_instruction" => $AudioDomain . $G1_L8_Speaking . "SubBlock_Look-at-the-picture-and-say-a.mp3", "q_content" => "Look at the picture and say a word."],
            ['round' => 9, 'game_id' => 45, 'q_image' => $l8G45image . "cake.png", "q_audio" => $AudioDomain . $G1_L8_Speaking . "cake.mp3", "round_instruction" => $AudioDomain . $G1_L8_Speaking . "SubBlock_Look-at-the-picture-and-say-a.mp3", "q_content" => "Look at the picture and say a word."],
            ['round' => 10, 'game_id' => 45, 'q_image' => $l8G45image . "bed.png", "q_audio" => $AudioDomain . $G1_L8_Speaking . "bed.mp3", "round_instruction" => $AudioDomain . $G1_L8_Speaking . "SubBlock_Look-at-the-picture-and-say-a.mp3", "q_content" => "Look at the picture and say a word."],
        ]);
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 48, 'a_content' => 'https://player.vimeo.com/video/943678785', 'isLocal' => 1]);
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 52, 'q_audio' => $AudioDomain . $G1_L9_Speaking  . "chameleon.mp3", 'q_image' => $l9G52image . "chameleon.png", "round_instruction" => $AudioDomain . $G1_L9_Speaking  . "Describe-the-pictures-Its.mp3", "q_content" => "Describe the pictures. It is ____."],
            ['round' => 2, 'game_id' => 52, 'q_audio' => $AudioDomain . $G1_L9_Speaking  . "parrot.mp3", 'q_image' => $l9G52image . "parrot.png", "round_instruction" => $AudioDomain . $G1_L9_Speaking  . "Describe-the-pictures-Its.mp3", "q_content" => "Describe the pictures. It is ____."],
            ['round' => 3, 'game_id' => 52, 'q_audio' => $AudioDomain . $G1_L9_Speaking  . "dog.mp3", 'q_image' => $l9G52image . "dog.png", "round_instruction" => $AudioDomain . $G1_L9_Speaking  . "Describe-the-pictures-Its.mp3", "q_content" => "Describe the pictures. It is ____."],
            ['round' => 4, 'game_id' => 52, 'q_audio' => $AudioDomain . $G1_L9_Speaking  . "cat.mp3", 'q_image' => $l9G52image . "cat.png", "round_instruction" => $AudioDomain . $G1_L9_Speaking  . "Describe-the-pictures-Its.mp3", "q_content" => "Describe the pictures. It is ____."],
            ['round' => 5, 'game_id' => 52, 'q_audio' => $AudioDomain . $G1_L9_Speaking  . "fish.mp3", 'q_image' => $l9G52image . "fish.png", "round_instruction" => $AudioDomain . $G1_L9_Speaking  . "Describe-the-pictures-Its.mp3", "q_content" => "Describe the pictures. It is ____."],
        ]);
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 54, 'a_content' => 'https://player.vimeo.com/video/943681209', 'isLocal' => 1]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            [
                'round' => 2, 'game_id' => 56, 'a_content' => "sheep", 'q_image' => $l10G56image . "sheep" . ".png",
                'a_audio' => $AudioDomain . $G1_L10_listen_n_practice . "sheep" . ".mp3", "background" => $l10G56image . "bg2.png"
            ],
            [
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 58, "q_audio" => $AudioDomain . $G1_L10_Speaking . "rabbit.mp3", 'q_image' => $l10G58image . "rabbit.png", "round_instruction" => $AudioDomain . $G1_L10_Speaking . "What-animals-do-you-see-on-the.mp3", "q_content" => "What animals do you see on the farm?"],
            ['round' => 2, 'game_id' => 58, "q_audio" => $AudioDomain . $G1_L10_Speaking . "pig.mp3", 'q_image' => $l10G58image . "pig.png", "round_instruction" => $AudioDomain . $G1_L10_Speaking . "What-animals-do-you-see-on-the.mp3", "q_content" => "What animals do you see on the farm?"],
            ['round' => 3, 'game_id' => 58, "q_audio" => $AudioDomain . $G1_L10_Speaking . "goat.mp3", 'q_image' => $l10G58image . "goat.png", "round_instruction" => $AudioDomain . $G1_L10_Speaking . "What-animals-do-you-see-on-the.mp3", "q_content" => "What animals do you see on the farm?"],
            ['round' => 4, 'game_id' => 58, "q_audio" => $AudioDomain . $G1_L10_Speaking . "horse.mp3", 'q_image' => $l10G58image . "horse.png", "round_instruction" => $AudioDomain . $G1_L10_Speaking . "What-animals-do-you-see-on-the.mp3", "q_content" => "What animals do you see on the farm?"],
            ['round' => 5, 'game_id' => 58, "q_audio" => $AudioDomain . $G1_L10_Speaking . "duck.mp3", 'q_image' => $l10G58image . "duck.png", "round_instruction" => $AudioDomain . $G1_L10_Speaking . "What-animals-do-you-see-on-the.mp3", "q_content" => "What animals do you see on the farm?"],
            ['round' => 6, 'game_id' => 58, "q_audio" => $AudioDomain . $G1_L10_Speaking . "sheep.mp3", 'q_image' => $l10G58image . "sheep.png", "round_instruction" => $AudioDomain . $G1_L10_Speaking . "What-animals-do-you-see-on-the.mp3", "q_content" => "What animals do you see on the farm?"],
            ['round' => 7, 'game_id' => 58, "q_audio" => $AudioDomain . $G1_L10_Speaking . "cock.mp3", 'q_image' => $l10G58image . "cock.png", "round_instruction" => $AudioDomain . $G1_L10_Speaking . "What-animals-do-you-see-on-the.mp3", "q_content" => "What animals do you see on the farm?"],
            ['round' => 8, 'game_id' => 58, "q_audio" => $AudioDomain . $G1_L10_Speaking . "cow.mp3", 'q_image' => $l10G58image . "cow.png", "round_instruction" => $AudioDomain . $G1_L10_Speaking . "What-animals-do-you-see-on-the.mp3", "q_content" => "What animals do you see on the farm?"],
            ['round' => 9, 'game_id' => 58, "q_audio" => $AudioDomain . $G1_L10_Speaking . "rabbit.mp3", 'q_image' => $l10G58image . "rabbit1.png", "round_instruction" => $AudioDomain . $G1_L10_Speaking . "What-animals-do-you-see-on-the.mp3", "q_content" => "What animals do you see on the farm?"],
        ]);
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 60, 'a_content' => 'https://player.vimeo.com/video/943682105', 'isLocal' => 1]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['game_id' => 63, 'round' => 1, 'q_content' => "apple", 'q_image' => $l11G63image . "redpen" . ".png", 'q_audio' => $AudioDomain . $G1_L11_Matching .  "red" . ".mp3"],
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 64, "q_audio" => $AudioDomain . $G1_L11_Speaking . "apple.mp3",  'q_image' => $l11G64image . "apple.png", "round_instruction" => $AudioDomain . $G1_L11_Speaking . "SubBlock_What-colour-is-it-what-is-it.mp3", "q_content" => "What colour is it ? What is it ?"],
            ['round' => 2, 'game_id' => 64, "q_audio" => $AudioDomain . $G1_L11_Speaking . "table.mp3",  'q_image' => $l11G64image . "table.png", "round_instruction" => $AudioDomain . $G1_L11_Speaking . "SubBlock_What-colour-is-it-what-is-it.mp3", "q_content" => "What colour is it ? What is it ?"],
            ['round' => 3, 'game_id' => 64, "q_audio" => $AudioDomain . $G1_L11_Speaking . "blue_balloon.mp3",  'q_image' => $l11G64image . "blue_balloon.png", "round_instruction" => $AudioDomain . $G1_L11_Speaking . "SubBlock_What-colour-is-it-what-is-it.mp3", "q_content" => "What colour is it ? What is it ?"],
            ['round' => 4, 'game_id' => 64, "q_audio" => $AudioDomain . $G1_L11_Speaking . "dress.mp3",  'q_image' => $l11G64image . "dress.png", "round_instruction" => $AudioDomain . $G1_L11_Speaking . "SubBlock_What-colour-is-it-what-is-it.mp3", "q_content" => "What colour is it ? What is it ?"],
            ['round' => 5, 'game_id' => 64, "q_audio" => $AudioDomain . $G1_L11_Speaking . "red_balloon.mp3",  'q_image' => $l11G64image . "red_balloon.png", "round_instruction" => $AudioDomain . $G1_L11_Speaking . "SubBlock_What-colour-is-it-what-is-it.mp3", "q_content" => "What colour is it ? What is it ?"],
            ['round' => 6, 'game_id' => 64, "q_audio" => $AudioDomain . $G1_L11_Speaking . "pink_balloon.mp3",  'q_image' => $l11G64image . "pink_balloon.png", "round_instruction" => $AudioDomain . $G1_L11_Speaking . "SubBlock_What-colour-is-it-what-is-it.mp3", "q_content" => "What colour is it ? What is it ?"],
            ['round' => 7, 'game_id' => 64, "q_audio" => $AudioDomain . $G1_L11_Speaking . "yellow_balloon.mp3",  'q_image' => $l11G64image . "yellow_balloon.png", "round_instruction" => $AudioDomain . $G1_L11_Speaking . "SubBlock_What-colour-is-it-what-is-it.mp3", "q_content" => "What colour is it ? What is it ?"],
            ['round' => 8, 'game_id' => 64, "q_audio" => $AudioDomain . $G1_L11_Speaking . "black_balloon.mp3",  'q_image' => $l11G64image . "black_balloon.png", "round_instruction" => $AudioDomain . $G1_L11_Speaking . "SubBlock_What-colour-is-it-what-is-it.mp3", "q_content" => "What colour is it ? What is it ?"],
            ['round' => 9, 'game_id' => 64, "q_audio" => $AudioDomain . $G1_L11_Speaking . "cat.mp3",  'q_image' => $l11G64image . "cat.png", "round_instruction" => $AudioDomain . $G1_L11_Speaking . "SubBlock_What-colour-is-it-what-is-it.mp3", "q_content" => "What colour is it ? What is it ?"],
            ['round' => 10, 'game_id' => 64, "q_audio" => $AudioDomain . $G1_L11_Speaking . "parrot.mp3",  'q_image' => $l11G64image . "parrot.png", "round_instruction" => $AudioDomain . $G1_L11_Speaking . "SubBlock_What-colour-is-it-what-is-it.mp3", "q_content" => "What colour is it ? What is it ?"],
        ]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 65, "q_image" => null, "q_audio" =>  $AudioDomain . $G1_L11_reading_passage_path . "ball_bear.mp3", 'q_content' => "ball, teddy bear", "q_conver" => null, 'a_content' => 1, "background" => null],
            ...
            ['round' => 3, 'game_id' => 65, "q_image" => null, "q_audio" =>  $AudioDomain . $G1_L11_reading_passage_path . "teddy_bear.mp3", 'q_content' => "dress", "q_conver" => null, 'a_content' => 0, "background" => null],
            ['round' => 3, 'game_id' => 65, "q_image" => null, "q_audio" =>  $AudioDomain . $G1_L11_reading_passage_path . "dree_ball.mp3", 'q_content' => "ball", "q_conver" => null, 'a_content' => 1, "background" => null],
            ...
            ['round' => 4, 'game_id' => 65, "q_image" => null, "q_audio" => $AudioDomain . $G1_L11_reading_passage_path . "car_doll_airplane.mp3", 'q_content' => "brown", "q_conver" => null, 'a_content' => 1, "background" => null],
            ['round' => 4, 'game_id' => 65, "q_image" => null, "q_audio" =>  $AudioDomain . $G1_L11_reading_passage_path . "ball_bear.mp3", 'q_content' => "blue", "q_conver" => null, 'a_content' => 0, "background" => null],
            ['round' => 4, 'game_id' => 65, "q_image" => null, "q_audio" =>  $AudioDomain . $G1_L11_reading_passage_path . "ball_bear.mp3", 'q_content' => "gray", "q_conver" => null, 'a_content' => 0, "background" => null],
            ['round' => 4, 'game_id' => 65, "q_image" => null, "q_audio" => $AudioDomain . $G1_L11_reading_passage_path . "What-color-is-the-teddy-bear.mp3", "q_conver" => "What color is the teddy bear?", 'q_content' => null, 'a_content' => null, "background" => null],
            ['round' => 4, 'game_id' => 65, "q_image" => null, "q_audio" => $AudioDomain . $G1_L11_reading_passage_path . "I-love-toys-I-play-with-them.mp3", "q_content" => "I love toys", 'q_conver' => "I love toys. I play with them after school. This is my teddy bear. It's brown and black. This is my doll. It's beautiful. Its dress is blue and purple. I also have a ball. I play with it everyday. It's yellow and blue.", 'a_content' => null, "background" => $l11G65image . "background.png"],


            ['round' => 5, 'game_id' => 65, "q_image" => null, "q_audio" =>  $AudioDomain . $G1_L11_reading_passage_path . "black_and_white.mp3", 'q_content' => "pink", "q_conver" => null, 'a_content' => 1, "background" => null],
            ['round' => 5, 'game_id' => 65, "q_image" => null, "q_audio" =>  $AudioDomain . $G1_L11_reading_passage_path . "blue_and_yellow.mp3", 'q_content' => "orange", "q_conver" => null, 'a_content' => 0, "background" => null],
            ['round' => 5, 'game_id' => 65, "q_image" => null, "q_audio" =>  $AudioDomain . $G1_L11_reading_passage_path . "red_and_green.mp3", 'q_content' => "blue", "q_conver" => null, 'a_content' => 0, "background" => null],
            ['round' => 5, 'game_id' => 65, "q_image" => null, "q_audio" => $AudioDomain . $G1_L11_reading_passage_path . "What-color-is-the-doll-pink.mp3", "q_conver" =>  "What color is the doll?", 'q_content' => null, 'a_content' => null, "background" => null],
            ['round' => 5, 'game_id' => 65, "q_image" => null, "q_audio" => $AudioDomain . $G1_L11_reading_passage_path . "I-love-toys-I-play-with-them.mp3", "q_content" => "I love toys", 'q_conver' => "I love toys. I play with them after school. This is my teddy bear. It's brown and black. This is my doll. It's beautiful. Its dress is blue and purple. I also have a ball. I play with it everyday. It's yellow and blue.", 'a_content' => null, "background" => $l11G65image . "background.png"],
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 73, 'a_content' => 'https://player.vimeo.com/video/943690928', 'isLocal' => 1]);
        ...
        $ansl13Content = [
            ["\"clean\" - It's clean.",  "\"dirty\" - It's dirty."],
            ["\"new\" - It's new.", "\"old\" - It's old."],
            ["\"fast\" - It's fast.", "\"slow\" - It's slow."],
            ["\"Hard\" - It's hard.", "\"soft\" - It's soft."],
            ["\"long\" - It's long.", "\"Short\" - It's short."],
            ["\"big\" - It's big.", "\"Small\" - It's small."]
        ];
        ...
        $ansl13Audio = [
            ["clean-Its-clean", "dirty-Its-dirty"],
            ["new-Its-new", "old-Its-old"],
            ["fast-Its-fast", "slow-Its-slow"],
            ["hard-Its-hard", "soft-Its-soft"],
            ["long---Its-long", "short-Its-short"],
            ["big-Its-big", "small-Its-small"]
        ];

        for ($i = 0; $i < count($ansl13Image); $i++) {
            for ($j = 0; $j < count($ansl13Image[$i]); $j++) {
                DB::table('ans_n_ques')->insert([
                    [
                        'game_id' => 74,
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 2, 'game_id' => 76, 'q_audio' => $AudioDomain . $G1_L13_listen_and_practice_path . "This-hat-is-old-True-or-False.mp3", 'q_content' => "true", 'a_content' => 1, 'q_image' => $l13G76image . "hat.png"],
            ...
            ['round' => 5, 'game_id' => 76, 'q_audio' => $AudioDomain . $G1_L13_listen_and_practice_path . "This-girl-is-dirty-True-or-Fal.mp3", 'q_content' => "true", 'a_content' => 1, 'q_image' => $l13G76image . "girl.png"],
        ...
        DB::table('ans_n_ques')->insert([
            ...
            // ['round' => 4, 'game_id' => 77, "q_audio" => $AudioDomain . $G1_L13_Speaking . "slow-Its-slow.mp3", 'q_image' => $l13G77image . "turtle.png", "round_instruction" => $AudioDomain . $G1_L13_Speaking . "Describe-the-pictures-Its.mp3", "q_content" => "Describe the picture. It's ____."],
            ['round' => 5, 'game_id' => 77, "q_audio" => $AudioDomain . $G1_L13_Speaking . "soft-Its-soft.mp3", 'q_image' => $l13G77image . "cake.png", "round_instruction" => $AudioDomain . $G1_L13_Speaking . "Describe-the-pictures-Its.mp3", "q_content" => "Describe the picture. It's ____."],
            ['round' => 6, 'game_id' => 77, "q_audio" => $AudioDomain . $G1_L13_Speaking . "fast-Its-fast.mp3", 'q_image' => $l13G77image . "rabbit.png", "round_instruction" => $AudioDomain . $G1_L13_Speaking . "Describe-the-pictures-Its.mp3", "q_content" => "Describe the picture. It's ____."],
            ['round' => 7, 'game_id' => 77, "q_audio" => $AudioDomain . $G1_L13_Speaking . "dirty-Its-dirty.mp3", 'q_image' => $l13G77image . "dirty_girl.png", "round_instruction" => $AudioDomain . $G1_L13_Speaking . "Describe-the-pictures-Its.mp3", "q_content" => "Describe the picture. It's ____."],
            ['round' => 8, 'game_id' => 77, "q_audio" => $AudioDomain . $G1_L13_Speaking . "new-Its-new.mp3", 'q_image' => $l13G77image . "car.png", "round_instruction" => $AudioDomain . $G1_L13_Speaking . "Describe-the-pictures-Its.mp3", "q_content" => "Describe the picture. It's ____."],

            ['round' => 9, 'game_id' => 77, "q_audio" => $AudioDomain . $G1_L13_Speaking . "old-Its-old.mp3", 'q_image' => $l13G77image . "book.png", "round_instruction" => $AudioDomain . $G1_L13_Speaking . "Describe-the-pictures-Its.mp3", "q_content" => "Describe the picture. It's ____."],
        ]);
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 78, 'a_content' => 'https://player.vimeo.com/video/943692330', 'isLocal' => 1]);
        ...
        $ansl14Content = [
            "This is a cake. It's soft. It's yellow",
            "This is a table. It's hard. It's grey.",
            "This is a car. It's old and slow. It's green.",
            "This is a car. It's small. It's orange.",
            "This is a fan. It's new. It's pink.",
            "This is a fan. It's dirty. It's blue.",
            "This is a house. It's clean. It's yellow and red.",
            "This is a house. It's old. It's black.",
            "This is a ruler. It's long. It's white.",
            "This is an apple. It's big. It's red.",
            "This is a pencil. It's short. It's brown.",
            "This is an airplane. It's fast. It's white."
        ];

        $ansl14Image = [
            "cake", "table", "old_car", "car_orange", "fan", "fan_blue", "house", "house_black", "ruler", "apple", "pencil", "plane"
        ];

        $ansl14Audio = [
            "This-is-a-cake-Its-soft-It", "This-is-a-table-Its-hard-It", "This-is-a-car-Its-old-and-sl", "This-is-a-car-Its-small-It", "This-is-a-fan-Its-new-Its", "This-is-a-fan-Its-dirty-It", "This-is-a-house-Its-clean-I", "This-is-a-house-Its-old-It", "This-is-a-ruler-Its-long-It", "This-is-an-apple-Its-big-It", "This-is-a-pencil-Its-short", "This-is-an-airplane-Its-fast"
        ];
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 83, "q_audio" => $AudioDomain . $G1_L14_Speaking . "This-is-a-pencil-Its-short.mp3",  'q_image' => $l14G83image . "pencil.png", "round_instruction" => $AudioDomain . $G1_L14_Speaking . "SubBlock_Describe-the-picture.mp3", "q_content" => "Describe the picture. \n Example \n  This is a pencil. It's yellow. (or) \n This is a pencil. It's short. (or) \n  This is a pencil. It's yellow and short."],

            ['round' => 2, 'game_id' => 83, "q_audio" => $AudioDomain . $G1_L14_Speaking . "This-is-a-hat-Its-new-Its.mp3",  'q_image' => $l14G83image . "hat.png", "round_instruction" => $AudioDomain . $G1_L14_Speaking . "SubBlock_Describe-the-picture.mp3", "q_content" => "This is ___. It's ___."],
            ['round' => 3, 'game_id' => 83, "q_audio" => $AudioDomain . $G1_L14_Speaking . "goat.mp3",  'q_image' => $l14G83image . "goat.png", "round_instruction" => $AudioDomain . $G1_L14_Speaking . "SubBlock_Describe-the-picture.mp3", "q_content" => "This is ___. It's ___."],
            ['round' => 4, 'game_id' => 83, "q_audio" => $AudioDomain . $G1_L14_Speaking . "This-is-a-fish-Its-small-It.mp3",  'q_image' => $l14G83image . "fish.png", "round_instruction" => $AudioDomain . $G1_L14_Speaking . "SubBlock_Describe-the-picture.mp3", "q_content" => "This is ___. It's ___."],
            ['round' => 5, 'game_id' => 83, "q_audio" => $AudioDomain . $G1_L14_Speaking . "This-is-a-house-Its-big-It.mp3",  'q_image' => $l14G83image . "house.png", "round_instruction" => $AudioDomain . $G1_L14_Speaking . "SubBlock_Describe-the-picture.mp3", "q_content" => "This is ___. It's ___."],

            ['round' => 6, 'game_id' => 83, "q_audio" => $AudioDomain . $G1_L14_Speaking . "This-is-an-apple-Its-big-It.mp3",  'q_image' => $l14G83image . "apple.png", "round_instruction" => $AudioDomain . $G1_L14_Speaking . "SubBlock_Describe-the-picture.mp3", "q_content" => "This is ___. It's ___."],
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 84, 'a_content' => 'https://player.vimeo.com/video/943703406', 'isLocal' => 1]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 85, 'a_image' => $l15G85image . "cat.gif", "a_audio" => $AudioDomain . $G1_L15_Read_Listen_n_Repeat_path . "dog_dog.mp3", "a_conver" =>  $l15G85image . "dog-dog.png", 'q_image' => $l15G85image . "dog.gif", "background" => $l15G85image . "bg.png"],
            ...
            ['round' => 2, 'game_id' => 85, 'a_image' => $l15G85image . "dog.gif", "a_audio" => $AudioDomain . $G1_L15_Read_Listen_n_Repeat_path . "cock_cock.mp3", "a_conver" =>  $l15G85image . "cock-cock.png", 'q_image' => $l15G85image . "cock.gif", "background" => $l15G85image . "bg.png"],
            ...
            ['round' => 3, 'game_id' => 86, 'a_image' => $l15G85image . "cat.gif", "a_audio" => $AudioDomain . $G1_L15_Read_Listen_n_Repeat_path . "mouse_mouse.mp3",  "a_conver" =>  $l15G85image . "mouse-mouse.png", 'q_image' => $l15G85image . "mouse.gif", "background" => $l15G85image . "bg3.jpg"],
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 90, "q_audio" => $AudioDomain . $G1_L15_Speaking . "dog.mp3", 'q_image' => $l15G90image . "dog.png", "round_instruction" => $AudioDomain . $G1_L15_Speaking . "SubBlock_describe-the-animals-and-their.mp3", "q_content" => "Describe the animals and their sizes and colours."],
            ['round' => 2, 'game_id' => 90, "q_audio" => $AudioDomain . $G1_L15_Speaking . "turtle.mp3", 'q_image' => $l15G90image . "turtle.png", "round_instruction" => $AudioDomain . $G1_L15_Speaking . "SubBlock_describe-the-animals-and-their.mp3", "q_content" => "Describe the animals and their sizes and colours."],
            ['round' => 3, 'game_id' => 90, "q_audio" => $AudioDomain . $G1_L15_Speaking . "cock.mp3", 'q_image' => $l15G90image . "cock.png", "round_instruction" => $AudioDomain . $G1_L15_Speaking . "SubBlock_describe-the-animals-and-their.mp3", "q_content" => "Describe the animals and their sizes and colours."],
            ['round' => 4, 'game_id' => 90, "q_audio" => $AudioDomain . $G1_L15_Speaking . "ant.mp3", 'q_image' => $l15G90image . "ant.png", "round_instruction" => $AudioDomain . $G1_L15_Speaking . "SubBlock_describe-the-animals-and-their.mp3", "q_content" => "Describe the animals and their sizes and colours."],
            ['round' => 5, 'game_id' => 90, "q_audio" => $AudioDomain . $G1_L15_Speaking . "cat.mp3", 'q_image' => $l15G90image . "cat.png", "round_instruction" => $AudioDomain . $G1_L15_Speaking . "SubBlock_describe-the-animals-and-their.mp3", "q_content" => "Describe the animals and their sizes and colours."],
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 92, 'a_content' => 'https://player.vimeo.com/video/943703716', 'isLocal' => 1]);
        ...
        DB::table('ans_n_ques')->insert([
            [
                ...
                'a_audio' => $AudioDomain . $G1_L16_listen_n_practice . "ketchup" . ".mp3", "background" => $l16G94image . "bg.jpg"
            ],
            [
                'round' => 1, 'game_id' => 94, 'a_content' => "jam", 'q_image' => $l16G94image . "jam1" . ".png",
                'a_audio' => $AudioDomain . $G1_L16_listen_n_practice . "jam" . ".mp3", "background" => $l16G94image . "bg.jpg"
            ],
            [
                'round' => 1, 'game_id' => 94, 'a_content' => "lollipop", 'q_image' => $l16G94image . "lollipop1" . ".png",
                'a_audio' => $AudioDomain . $G1_L16_listen_n_practice . "lollipop" . ".mp3", "background" => $l16G94image . "bg.jpg"
            ],
            [
                'round' => 1, 'game_id' => 94, 'a_content' => "key", 'q_image' => $l16G94image . "key" . ".png",
                'a_audio' => $AudioDomain . $G1_L16_listen_n_practice . "key" . ".mp3", "background" => $l16G94image . "bg.jpg"
            ],
            [
                'round' => 1, 'game_id' => 94, 'a_content' => "lock", 'q_image' => $l16G94image . "lock" . ".png",
                'a_audio' => $AudioDomain . $G1_L16_listen_n_practice . "lock" . ".mp3", "background" => $l16G94image . "bg.jpg"
            ],
            ...
            [
                ...
                'a_audio' => $AudioDomain . $G1_L16_listen_n_practice . "ice-cream" . ".mp3", "background" => $l16G94image . "bg.jpg"
            ],
            [
                'round' => 2, 'game_id' => 94, 'a_content' => "ice", 'q_image' => $l16G94image . "ice" . ".png",
                'a_audio' => $AudioDomain . $G1_L16_listen_n_practice . "ice" . ".mp3", "background" => $l16G94image . "bg.jpg"
            ],
            [
                'round' => 2, 'game_id' => 94, 'a_content' => "lemon", 'q_image' => $l16G94image . "lemon" . ".png",
                'a_audio' => $AudioDomain . $G1_L16_listen_n_practice . "lemon" . ".mp3", "background" => $l16G94image . "bg.jpg"
            ],
        ...
        DB::table('ans_n_ques')->insert([
            ...
            // game 96
            ['round' => 1, 'game_id' => 96, "q_audio" => $AudioDomain . $G1_L16_Speaking . "jacket.mp3", 'round_instruction' => $AudioDomain . $G1_L16_Speaking . "Its-cold-I-need-a-fan-or-a" . ".mp3", 'q_image' => $l16_G96_G97_image . "cold.png", "q_content" => "It's cold. I need \"a fan or a jacket\"."],
            ['round' => 2, 'game_id' => 96, "q_audio" => $AudioDomain . $G1_L16_Speaking . "ketchup.mp3", 'round_instruction' => $AudioDomain . $G1_L16_Speaking . "Im-eating-hamburger-I-need-j" . ".mp3", 'q_image' => $l16_G96_G97_image . "eating.png", "q_content" => "I'm eating hamburger. I need \"jam or ketchup\"."],
            ['round' => 3, 'game_id' => 96, "q_audio" => $AudioDomain . $G1_L16_Speaking . "ice.mp3", 'round_instruction' => $AudioDomain . $G1_L16_Speaking . "Im-drinking-juice-I-need-ice" . ".mp3", 'q_image' => $l16_G96_G97_image . "drinking.png", "q_content" => "I'm drinking juice. I need \"ice or ice cream\"."],
            ['round' => 4, 'game_id' => 96, "q_audio" => $AudioDomain . $G1_L16_Speaking . "lamp.mp3", 'round_instruction' => $AudioDomain . $G1_L16_Speaking . "Turn-on-the-lamp--or-iron" . ".mp3", 'q_image' => $l16_G96_G97_image . "lamp.png", "q_content" => "Turn on the \"lamp or iron\"."],
            ['round' => 5, 'game_id' => 96, "q_audio" => $AudioDomain . $G1_L16_Speaking . "key.mp3", 'round_instruction' => $AudioDomain . $G1_L16_Speaking . "I-need-to-open-the-door-I-nee" . ".mp3", 'q_image' => $l16_G96_G97_image . "door.png", "q_content" => "I need to open the door. I need \"key or lock\"."],


            // game 97
            ['round' => 1, 'game_id' =>  97, "q_audio" =>  $AudioDomain . $G1_L16_Speaking . "lemon.mp3", 'round_instruction' =>  $AudioDomain . $G1_L16_Speaking . "Look-at-the-half-of-the-picture.mp3", 'q_image' => $l16_G96_G97_image . "lemon.png", "q_content" => "Look at the half of the picture and say a word."],
            ['round' => 2, 'game_id' =>  97, "q_audio" =>  $AudioDomain . $G1_L16_Speaking . "ink.mp3", 'round_instruction' =>  $AudioDomain . $G1_L16_Speaking . "Look-at-the-half-of-the-picture.mp3", 'q_image' => $l16_G96_G97_image . "ink.png", "q_content" => "Look at the half of the picture and say a word."],
            ['round' => 3, 'game_id' =>  97, "q_audio" =>  $AudioDomain . $G1_L16_Speaking . "kite.mp3", 'round_instruction' =>  $AudioDomain . $G1_L16_Speaking . "Look-at-the-half-of-the-picture.mp3", 'q_image' => $l16_G96_G97_image . "kite.png", "q_content" => "Look at the half of the picture and say a word."],
            ['round' => 4, 'game_id' =>  97, "q_audio" =>  $AudioDomain . $G1_L16_Speaking . "lollipop.mp3", 'round_instruction' =>  $AudioDomain . $G1_L16_Speaking . "Look-at-the-half-of-the-picture.mp3", 'q_image' => $l16_G96_G97_image . "lollipop.png", "q_content" => "Look at the half of the picture and say a word."],
            ['round' => 5, 'game_id' =>  97, "q_audio" =>  $AudioDomain . $G1_L16_Speaking . "icecream.mp3", 'round_instruction' =>  $AudioDomain . $G1_L16_Speaking . "Look-at-the-half-of-the-picture.mp3", 'q_image' => $l16_G96_G97_image . "icecream.png", "q_content" => "Look at the half of the picture and say a word."],
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 107, 'a_content' => 'https://player.vimeo.com/video/943706545', 'isLocal' => 1]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 3, 'game_id' => 112, "q_audio" => $AudioDomain . $G1_L18_Speaking . "Touch-your-back.mp3", 'round_instruction' => $AudioDomain . $G1_L18_Speaking . "Look-at-the-pictures-say-a-sen" . ".mp3", 'q_image' => $l18G112image . "back.png", "q_content" => "Look at the picture and say the sentence. \nDon't touch your back."],
            ['round' => 4, 'game_id' => 112, "q_audio" => $AudioDomain . $G1_L18_Speaking . "Touch-your-knee.mp3", 'round_instruction' => $AudioDomain . $G1_L18_Speaking . "Look-at-the-pictures-say-a-sen" . ".mp3", 'q_image' => $l18G112image . "knee.png", "q_content" => "Look at the picture and say the sentence. \nTouch your ____."],
            ['round' => 1, 'game_id' => 112, "q_audio" => $AudioDomain . $G1_L18_Speaking . "SubBlock_Touch-your-finger.mp3", 'round_instruction' => $AudioDomain . $G1_L18_Speaking . "Look-at-the-pictures-say-a-sen" . ".mp3", 'q_image' => $l18G112image . "finger.png", "q_content" => "Look at the picture and say the sentence. \nTouch your ____."],
            ['round' => 2, 'game_id' => 112, "q_audio" => $AudioDomain . $G1_L18_Speaking . "SubBlock_Touch-your-Shoulder.mp3", 'round_instruction' => $AudioDomain . $G1_L18_Speaking . "Look-at-the-pictures-say-a-sen" . ".mp3", 'q_image' => $l18G112image . "shoulder.png", "q_content" => "Look at the picture and say the sentence. \nTouch your ____."],
            ['round' => 5, 'game_id' => 112, "q_audio" => $AudioDomain . $G1_L18_Speaking . "Touch-your-arm.mp3", 'round_instruction' => $AudioDomain . $G1_L18_Speaking . "Look-at-the-pictures-say-a-sen" . ".mp3", 'q_image' => $l18G112image . "hand.png", "q_content" => "Look at the picture and say the sentence. \nTouch your ____."],
            ['round' => 6, 'game_id' => 112, "q_audio" => $AudioDomain . $G1_L18_Speaking . "Dont-touch-your-feet.mp3", 'round_instruction' => $AudioDomain . $G1_L18_Speaking . "Look-at-the-pictures-say-a-sen" . ".mp3", 'q_image' => $l18G112image . "feet.png", "q_content" => "Look at the picture and say the sentence. \nDon't touch your ____."],
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 113, 'a_content' => 'https://player.vimeo.com/video/943706690', 'isLocal' => 1]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 117, "q_image" => null, "q_audio" => $AudioDomain . $G1_L19_reading_passage_path . "This-is-a-pink-apple-She-has.mp3", "q_content" => null, 'q_conver' => "This is a pink apple. She has a big face. She has two blue eyes. She has a nose. She has small lips. She has no ears. She has no hair.", 'a_content' => null, "background" => $l19G117image . "bg.png"],
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 118, "q_audio" =>  $AudioDomain . $G1_L19_Speaking . "SubBlock_Touch-your-legs.mp3", "round_instruction" =>  $AudioDomain . $G1_L19_Speaking . "Look-at-the-pictures-say-a-sen" . ".mp3", 'q_image' => $l19G118image . "leg.png", "q_content" => "Look at the picture and say the sentence.\nTouch your ____."],
            ['round' => 2, 'game_id' => 118, "q_audio" =>  $AudioDomain . $G1_L19_Speaking . "Dont-touch-your-ankle.mp3", "round_instruction" =>  $AudioDomain . $G1_L19_Speaking . "Look-at-the-pictures-say-a-sen" . ".mp3", 'q_image' => $l19G118image . "ankle.png", "q_content" => "Look at the picture say the sentence.\nDon't touch your ____."],
            ['round' => 3, 'game_id' => 118, "q_audio" =>  $AudioDomain . $G1_L19_Speaking . "Dont-touch-your-feet.mp3", "round_instruction" =>  $AudioDomain . $G1_L19_Speaking . "Look-at-the-pictures-say-a-sen" . ".mp3", 'q_image' => $l19G118image . "feet.png", "q_content" => "Look at the picture say the sentence.\nDon't touch your ____."],
            ['round' => 4, 'game_id' => 118, "q_audio" =>  $AudioDomain . $G1_L19_Speaking . "Dont-touch-your-thigh.mp3", "round_instruction" =>  $AudioDomain . $G1_L19_Speaking . "Look-at-the-pictures-say-a-sen" . ".mp3", 'q_image' => $l19G118image . "thigh.png", "q_content" => "Look at the picture say the sentence. \nDon't touch your ____."],
            ['round' => 5, 'game_id' => 118, "q_audio" =>  $AudioDomain . $G1_L19_Speaking . "touch-your-waist.mp3", "round_instruction" =>  $AudioDomain . $G1_L19_Speaking . "Look-at-the-pictures-say-a-sen" . ".mp3", 'q_image' => $l19G118image . "waist.png", "q_content" => "Look at the picture say the sentence. \nTouch your ____."],
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 119, 'a_content' => 'https://player.vimeo.com/video/943711236', 'isLocal' => 1]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 2, 'game_id' => 124, 'q_audio' => $AudioDomain . $G1_L20_Speaking . "noodles.mp3", 'q_image' => $l20_G123_G124_image . "noodle.png", "round_instruction" => $AudioDomain . $G1_L20_Speaking . "Look-at-the-half-of-the-pictur.mp3", "q_content" => "Look at the half of the picture and say a word."],
            ['round' => 3, 'game_id' => 124, 'q_audio' => $AudioDomain . $G1_L20_Speaking . "mushroom.mp3", 'q_image' => $l20_G123_G124_image . "mushroom.png", "round_instruction" => $AudioDomain . $G1_L20_Speaking . "Look-at-the-half-of-the-pictur.mp3", "q_content" => "Look at the half of the picture and say a word."],
            ['round' => 4, 'game_id' => 124, 'q_audio' => $AudioDomain . $G1_L20_Speaking . "nest.mp3", 'q_image' => $l20_G123_G124_image . "nest.png", "round_instruction" => $AudioDomain . $G1_L20_Speaking . "Look-at-the-half-of-the-pictur.mp3", "q_content" => "Look at the half of the picture and say a word."],
            ['round' => 5, 'game_id' => 124, 'q_audio' => $AudioDomain . $G1_L20_Speaking . "nine.mp3", 'q_image' => $l20_G123_G124_image . "nine.png", "round_instruction" => $AudioDomain . $G1_L20_Speaking . "Look-at-the-half-of-the-pictur.mp3", "q_content" => "Look at the half of the picture and say a word."],
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 127, 'a_content' => 'https://player.vimeo.com/video/943711433', 'isLocal' => 1]);
        ...
        DB::table('ans_n_ques')->insert([
            [
                'round' => 1, 'game_id' => 130, 'a_content' => "bread", 'q_image' => $l21G130image . "bread" . ".png",
                'a_audio' => $AudioDomain . $G1_L21_listen_n_practice . "bread" . ".mp3", "background" => $l21G130image . "bg.png"
            ],
            [
                'round' => 1, 'game_id' => 130, 'a_content' => "meat", 'q_image' => $l21G130image . "meat" . ".png",
                'a_audio' => $AudioDomain . $G1_L21_listen_n_practice . "meat" . ".mp3", "background" => $l21G130image . "bg.png"
            ],
            [
                'round' => 1, 'game_id' => 130, 'a_content' => "vegetable", 'q_image' => $l21G130image . "vegetable" . ".png",
                'a_audio' => $AudioDomain . $G1_L21_listen_n_practice . "vegetables" . ".mp3", "background" => $l21G130image . "bg.png"
            ],
            [
                'round' => 1, 'game_id' => 130, 'a_content' => "cheese", 'q_image' => $l21G130image . "cheese" . ".png",
                'a_audio' => $AudioDomain . $G1_L21_listen_n_practice . "cheese" . ".mp3", "background" => $l21G130image . "bg.png"
            ],
            [
                'round' => 1, 'game_id' => 130, 'a_content' => "fruits", 'q_image' => $l21G130image . "fruits" . ".png",
                'a_audio' => $AudioDomain . $G1_L21_listen_n_practice . "fruit" . ".mp3", "background" => $l21G130image . "bg.png"
            ],
            [
                'round' => 1, 'game_id' => 130, 'a_content' => "soup", 'q_image' => $l21G130image . "soup" . ".png",
                'a_audio' => $AudioDomain . $G1_L21_listen_n_practice . "soup" . ".mp3", "background" => $l21G130image . "bg.png"
            ],


            [
                'round' => 2, 'game_id' => 130, 'a_content' => "I eat chocolate ice cream", 'q_image' => $l21G130image . "chcoCake" . ".png",
                'a_audio' => $AudioDomain . $G1_L21_listen_n_practice . "I-eat-chocolate-ice-cream" . ".mp3", "background" => $l21G130image . "bg.png"
            ],
            [
                'round' => 2, 'game_id' => 130, 'a_content' => "I eat cheese cake", 'q_image' => $l21G130image . "cheese" . ".png",
                'a_audio' => $AudioDomain . $G1_L21_listen_n_practice . "I-eat-cheese-cake" . ".mp3", "background" => $l21G130image . "bg.png"
            ],
            [
                'round' => 2, 'game_id' => 130, 'a_content' => "I eat chocolate cookies", 'q_image' => $l21G130image . "cookie" . ".png",
                'a_audio' => $AudioDomain . $G1_L21_listen_n_practice . "I-eat-chocolate-cookies" . ".mp3", "background" => $l21G130image . "bg.png"
            ],
            [
                'round' => 2, 'game_id' => 130, 'a_content' => "I eat chocolate bread", 'q_image' => $l21G130image . "bread" . ".png",
                'a_audio' => $AudioDomain . $G1_L21_listen_n_practice . "I-eat-chocolate-bread" . ".mp3", "background" => $l21G130image . "bg.png"
            ],
        ]);
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 133, 'a_content' => 'https://player.vimeo.com/video/943711509', 'isLocal' => 1]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            [
                'round' => 1, 'game_id' => 136, 'a_content' => "water", 'q_image' => $l22G136image . "water" . ".png",
            ...
            [
                'round' => 2, 'game_id' => 136, 'a_content' => "tea", 'q_image' => $l22G136image . "tea" . ".png",
                'a_audio' => $AudioDomain . $G1_L22_listen_n_practice . "tea" . ".mp3", "background" => $l22G136image . "bg.png"
            ],
            [
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 140, 'a_content' => 'https://player.vimeo.com/video/943713746', 'isLocal' => 1]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 145, "q_image" => null, "q_audio" => $AudioDomain . $G1_L23_reading_passage_path . "plus.mp3", "q_content" => "We talk about food.", 'q_conver' => "I like milk. I drink milk. I don't like vegetables. I like fruits. I eat bananas. \nI like juice. I drink orange juice. I eat eggs and vegetables. I don't like fruits.", 'a_content' => null, "background" => $l23G145image . "bg.jpg"],
            ...
            ['round' => 2, 'game_id' => 145, "q_image" => null, "q_audio" => $AudioDomain . $G1_L23_reading_passage_path . "plus.mp3", "q_content" => "We talk about food.", 'q_conver' => "I like milk. I drink milk. I don't like vegetables. I like fruits. I eat bananas. \nI like juice. I drink orange juice. I eat eggs and vegetables. I don't like fruits.", 'a_content' => null, "background" => $l23G145image . "bg.jpg"],
            ...
            // ['round' => 3, 'game_id' => 145, "q_image" => null, "q_audio" => $AudioDomain . $G1_L23_reading_passage_path . "I-like-juice-I-drink-orange-j.mp3", "q_conver" => " \nI like juice. I drink orange juice. I eat eggs and vegetables. I don't like fruits.", 'q_content' => null, 'a_content' => null, "background" => null],
            ['round' => 3, 'game_id' => 145, "q_image" => null, "q_audio" => $AudioDomain . $G1_L23_reading_passage_path . "plus.mp3", "q_content" => "We talk about food.", 'q_conver' => "I like milk. I drink milk. I don't like vegetables. I like fruits. I eat bananas. \nI like juice. I drink orange juice. I eat eggs and vegetables. I don't like fruits.", 'a_content' => null, "background" => $l23G145image . "bg.jpg"],
            ...
            // ['round' => 4, 'game_id' => 145, "q_image" => null, "q_audio" => $AudioDomain . $G1_L23_reading_passage_path . "I-like-juice-I-drink-orange-j.mp3", "q_conver" => " \nI like juice. I drink orange juice. I eat eggs and vegetables. I don't like fruits..", 'q_content' => null, 'a_content' => null, "background" => null],
            ['round' => 4, 'game_id' => 145, "q_image" => null, "q_audio" => $AudioDomain . $G1_L23_reading_passage_path . "plus.mp3", "q_content" => "We talk about food.", 'q_conver' => "I like milk. I drink milk. I don't like vegetables. I like fruits. I eat bananas. \nI like juice. I drink orange juice. I eat eggs and vegetables. I don't like fruits.", 'a_content' => null, "background" => $l23G145image . "bg.jpg"],
            ...
            // ['round' => 5, 'game_id' => 145, "q_image" => null, "q_audio" => $AudioDomain . $G1_L23_reading_passage_path . "I-like-juice-I-drink-orange-j.mp3", "q_conver" => " \nI like juice. I drink orange juice. I eat eggs and vegetables. I don't like fruits.", 'q_content' => null, 'a_content' => null, "background" => null],
            ['round' => 5, 'game_id' => 145, "q_image" => null, "q_audio" => $AudioDomain . $G1_L23_reading_passage_path . "plus.mp3", "q_content" => "We talk about food.", 'q_conver' => "I like milk. I drink milk. I don't like vegetables. I like fruits. I eat bananas. \nI like juice. I drink orange juice. I eat eggs and vegetables. I don't like fruits.", 'a_content' => null, "background" => $l23G145image . "bg.jpg"],
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 146, "q_audio" => $AudioDomain . $G1_L23_Speaking . "cookies.mp3", 'q_image' => $l23_G146_image . "cookie.png", "round_instruction" => $AudioDomain . $G1_L23_Speaking . "SubBlock_Describle-the-picture-and-say.mp3", "q_content" => "Describe the picture and say what do you like? \nI like ____."],
            ['round' => 2, 'game_id' => 146, "q_audio" => $AudioDomain . $G1_L23_Speaking . "SubBlock_jam.mp3", 'q_image' => $l23_G146_image . "jam.png", "round_instruction" => $AudioDomain . $G1_L23_Speaking . "SubBlock_Describle-the-picture-and-say.mp3", "q_content" => "Describe the picture and say what do you like? \nI like ____."],
            ['round' => 3, 'game_id' => 146, "q_audio" => $AudioDomain . $G1_L23_Speaking . "fish.mp3", 'q_image' => $l23_G146_image . "meat.png", "round_instruction" => $AudioDomain . $G1_L23_Speaking . "SubBlock_Describle-the-picture-and-say.mp3", "q_content" => "Describe the picture and say what do you like? \nI like ____ ."],
            ['round' => 4, 'game_id' => 146, "q_audio" => $AudioDomain . $G1_L23_Speaking . "chicken-rice.mp3", 'q_image' => $l23_G146_image . "egg.png", "round_instruction" => $AudioDomain . $G1_L23_Speaking . "SubBlock_Describle-the-picture-and-say.mp3", "q_content" => "Describe the picture and say what do you like? \nI like ____."],
            ['round' => 5, 'game_id' => 146, "q_audio" => $AudioDomain . $G1_L23_Speaking . "water.mp3", 'q_image' => $l23_G146_image . "soda.png", "round_instruction" => $AudioDomain . $G1_L23_Speaking . "SubBlock_Describle-the-picture-and-say.mp3", "q_content" => "Describe the picture and say what do you like? \nI like ____."],
            ['round' => 6, 'game_id' => 146, "q_audio" => $AudioDomain . $G1_L23_Speaking . "SubBlock_Chocolate-cake.mp3", 'q_image' => $l23_G146_image . "cake.png", "round_instruction" => $AudioDomain . $G1_L23_Speaking . "SubBlock_Describle-the-picture-and-say.mp3", "q_content" => "Describe the picture and say what do you like? \nI like ____ ."],
            ['round' => 7, 'game_id' => 146, "q_audio" => $AudioDomain . $G1_L23_Speaking . "apple-juice.mp3", 'q_image' => $l23_G146_image . "juice.png", "round_instruction" => $AudioDomain . $G1_L23_Speaking . "SubBlock_Describle-the-picture-and-say.mp3", "q_content" => "Describe the picture and say what do you like? \nI like ____ ."],
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 147, 'a_content' => 'https://player.vimeo.com/video/943713831', 'isLocal' => 1]);
        ...
        DB::table('ans_n_ques')->insert([
            [
                ...
                'a_audio' => $AudioDomain . $G1_L24_listen_n_practice . "egg" . ".mp3", "background" => $l24G149image . "bg.jpg"
            ],
            [
                'round' => 1, 'game_id' => 149, 'a_content' => "meat", 'q_image' => $l24G149image . "meat" . ".png",
                'a_audio' => $AudioDomain . $G1_L24_listen_n_practice . "meat" . ".mp3", "background" => $l24G149image . "bg.jpg"
            ],
            [
                'round' => 1, 'game_id' => 149, 'a_content' => "cheese", 'q_image' => $l24G149image . "cheese" . ".png",
                'a_audio' => $AudioDomain . $G1_L24_listen_n_practice . "cheese" . ".mp3", "background" => $l24G149image . "bg.jpg"
            ],
            [
                'round' => 1, 'game_id' => 149, 'a_content' => "soda", 'q_image' => $l24G149image . "soda" . ".png",
                'a_audio' => $AudioDomain . $G1_L24_listen_n_practice . "soda" . ".mp3", "background" => $l24G149image . "bg.jpg"
            ],
            [
                'round' => 1, 'game_id' => 149, 'a_content' => "cookie", 'q_image' => $l24G149image . "cookies" . ".png",
                'a_audio' => $AudioDomain . $G1_L24_listen_n_practice . "cookies" . ".mp3", "background" => $l24G149image . "bg.jpg"
            ],


            [
                'round' => 2, 'game_id' => 149, 'a_content' => "coke", 'q_image' => $l24G149image . "coke" . ".png",
                'a_audio' => $AudioDomain . $G1_L24_listen_n_practice . "coke" . ".mp3", "background" => $l24G149image . "bg.jpg"
            ],
            [
                'round' => 2, 'game_id' => 149, 'a_content' => "bread", 'q_image' => $l24G149image . "bread" . ".png",
                'a_audio' => $AudioDomain . $G1_L24_listen_n_practice . "bread" . ".mp3", "background" => $l24G149image . "bg.jpg"
            ],
            [
                'round' => 2, 'game_id' => 149, 'a_content' => "milk", 'q_image' => $l24G149image . "milk" . ".png",
                'a_audio' => $AudioDomain . $G1_L24_listen_n_practice . "milk" . ".mp3", "background" => $l24G149image . "bg.jpg"
            ],
            [
                'round' => 2, 'game_id' => 149, 'a_content' => "cake", 'q_image' => $l24G149image . "cake" . ".png",
                'a_audio' => $AudioDomain . $G1_L24_listen_n_practice . "cake" . ".mp3", "background" => $l24G149image . "bg.jpg"
            ],
            [
                'round' => 2, 'game_id' => 149, 'a_content' => "bag", 'q_image' => $l24G149image . "bag" . ".png",
                'a_audio' => $AudioDomain . $G1_L24_listen_n_practice . "bag" . ".mp3", "background" => $l24G149image . "bg.jpg"
            ],
        ]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 151, "q_audio" =>  $AudioDomain . $G1_L24_Speaking . "Yes-I-do.mp3", 'round_instruction' =>  $AudioDomain . $G1_L24_Speaking . "SubBlock_Do-you-like-chocolate-cookies" . ".mp3", 'q_image' => $l24_G151_image . "cookie.png", "q_content" => "Do you like chocolate cookies? \nYes, ____."],
            ['round' => 2, 'game_id' => 151, "q_audio" =>  $AudioDomain . $G1_L24_Speaking . "Yes-I-do.mp3", 'round_instruction' =>  $AudioDomain . $G1_L24_Speaking . "SubBlock_Do-you-like-orange-juice" . ".mp3", 'q_image' => $l24_G151_image . "mangojuice.png", "q_content" => "Do you like orange juice? \nYes, ____."],
            ['round' => 3, 'game_id' => 151, "q_audio" =>  $AudioDomain . $G1_L24_Speaking . "No-I-dont.mp3", 'round_instruction' =>  $AudioDomain . $G1_L24_Speaking . "SubBlock_Do-you-like-lemon-juice" . ".mp3", 'q_image' => $l24_G151_image . "lemonjuice.png", "q_content" => "Do you like lemon juice? \nNo, ____."],
            ['round' => 4, 'game_id' => 151, "q_audio" =>  $AudioDomain . $G1_L24_Speaking . "No-I-dont.mp3", 'round_instruction' =>  $AudioDomain . $G1_L24_Speaking . "SubBlock_do-you-like-vegetable" . ".mp3", 'q_image' => $l24_G151_image . "vege.png", "q_content" => "Do you like vegetable? \nNo, ____."],
            ['round' => 5, 'game_id' => 151, "q_audio" =>  $AudioDomain . $G1_L24_Speaking . "Yes-I-do.mp3", 'round_instruction' =>  $AudioDomain . $G1_L24_Speaking . "SubBlock_do-you-like-milk" . ".mp3", 'q_image' => $l24_G151_image . "milk.png", "q_content" => "Do you like milk? \nYes, ____."],
            ['round' => 6, 'game_id' => 151, "q_audio" =>  $AudioDomain . $G1_L24_Speaking . "No-I-dont.mp3", 'round_instruction' =>  $AudioDomain . $G1_L24_Speaking . "SubBlock_do-you-like-egg" . ".mp3", 'q_image' => $l24_G151_image . "egg.png", "q_content" => "Do you like egg? \nNo, ____."],
            ['round' => 7, 'game_id' => 151, "q_audio" =>  $AudioDomain . $G1_L24_Speaking . "Yes-I-do.mp3", 'round_instruction' =>  $AudioDomain . $G1_L24_Speaking . "SubBlock_Do-you-like-bread" . ".mp3", 'q_image' => $l24_G151_image . "bread.png", "q_content" => "Do you like bread? \nYes, ____."],
            ['round' => 8, 'game_id' => 151, "q_audio" =>  $AudioDomain . $G1_L24_Speaking . "No-I-dont.mp3", 'round_instruction' =>  $AudioDomain . $G1_L24_Speaking . "SubBlock_Do-you-like-coffee" . ".mp3", 'q_image' => $l24_G151_image . "coffee.png", "q_content" => "Do you like coffee? \nNo, ____."],
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 153, 'a_content' => 'https://player.vimeo.com/video/943714093', 'isLocal' => 1]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 157, "q_audio" => $AudioDomain . $G1_L25_Speaking . "papaya.mp3", 'q_image' => $l25_G157_image . "papaya.png", "round_instruction" => $AudioDomain . $G1_L25_Speaking . "SubBlock_Describe-the-picture-and-say.mp3", "q_content" => "Describe the picture and say \nThis is a ____, it's ____."],
            ['round' => 2, 'game_id' => 157, "q_audio" => $AudioDomain . $G1_L25_Speaking . "pear.mp3", 'q_image' => $l25_G157_image . "pear.png", "round_instruction" => $AudioDomain . $G1_L25_Speaking . "SubBlock_Describe-the-picture-and-say.mp3", "q_content" => "Describe the picture and say \nThis is a ____, it's ____."],
            ['round' => 3, 'game_id' => 157, "q_audio" => $AudioDomain . $G1_L25_Speaking . "olive.mp3", 'q_image' => $l25_G157_image . "olive.png", "round_instruction" => $AudioDomain . $G1_L25_Speaking . "SubBlock_Describe-the-picture-and-say.mp3", "q_content" => "Describe the picture and say \nThis is a ____, it's ____."],
            ['round' => 4, 'game_id' => 157, "q_audio" => $AudioDomain . $G1_L25_Speaking . "pelican.mp3", 'q_image' => $l25_G157_image . "pelican.png", "round_instruction" => $AudioDomain . $G1_L25_Speaking . "SubBlock_Describe-the-picture-and-say.mp3", "q_content" => "Describe the picture and say \nThis is a ____, it's ____."],
            ['round' => 5, 'game_id' => 157, "q_audio" => $AudioDomain . $G1_L25_Speaking . "parrot.mp3", 'q_image' => $l25_G157_image . "parrot.png", "round_instruction" => $AudioDomain . $G1_L25_Speaking . "SubBlock_Describe-the-picture-and-say.mp3", "q_content" => "Describe the picture and say \nThis is a ____, it's ____."],
            ['round' => 6, 'game_id' => 157, "q_audio" => $AudioDomain . $G1_L25_Speaking . "orange.mp3", 'q_image' => $l25_G157_image . "orange.png", "round_instruction" => $AudioDomain . $G1_L25_Speaking . "SubBlock_Describe-the-picture-and-say.mp3", "q_content" => "Describe the picture and say \nThis is a ____, it's ____."],
            ['round' => 7, 'game_id' => 157, "q_audio" => $AudioDomain . $G1_L25_Speaking . "pomelo.mp3", 'q_image' => $l25_G157_image . "pomelo.png", "round_instruction" => $AudioDomain . $G1_L25_Speaking . "SubBlock_Describe-the-picture-and-say.mp3", "q_content" => "Describe the picture and say \nThis is a ____, it's ____."],
            ['round' => 8, 'game_id' => 157, "q_audio" => $AudioDomain . $G1_L25_Speaking . "penguin.mp3", 'q_image' => $l25_G157_image . "penguin.png", "round_instruction" => $AudioDomain . $G1_L25_Speaking . "SubBlock_Describe-the-picture-and-say.mp3", "q_content" => "Describe the picture and say \nThis is a ____, it's ____."],
            ['round' => 9, 'game_id' => 157, "q_audio" => $AudioDomain . $G1_L25_Speaking . "ostrich.mp3", 'q_image' => $l25_G157_image . "ostrich.png", "round_instruction" => $AudioDomain . $G1_L25_Speaking . "SubBlock_Describe-the-picture-and-say.mp3", "q_content" => "Describe the picture and say \nThis is a ____, it's ____."],
            ['round' => 10, 'game_id' => 157, "q_audio" => $AudioDomain . $G1_L25_Speaking . "peacock.mp3", 'q_image' => $l25_G157_image . "peacock.png", "round_instruction" => $AudioDomain . $G1_L25_Speaking . "SubBlock_Describe-the-picture-and-say.mp3", "q_content" => "Describe the picture and say \nThis is a ____, it's ____."],
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 160, 'a_content' => 'https://player.vimeo.com/video/943881886', 'isLocal' => 1]);
        ...
        $ansl26G161Content = [
            "Apple", "Avocado", "Banana", "Blueberries", "Cherry", "Coconut", "Custard-apple", "Dragon fruit", "durian", "grapes", "guava", "Jackfruit", "Kiwi"
        ];
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 165, "q_audio" => $AudioDomain . $G1_L26_Speaking . "apple.mp3",  'q_image' => $l26_G165_image . "apple.png", "round_instruction" => $AudioDomain . $G1_L26_Speaking . "Describe-the-pictures-Its.mp3", "q_content" => "Describe the picture. \nIt's ............"],
            ['round' => 2, 'game_id' => 165, "q_audio" => $AudioDomain . $G1_L26_Speaking . "orange.mp3",  'q_image' => $l26_G165_image . "orange.png", "round_instruction" => $AudioDomain . $G1_L26_Speaking . "Describe-the-pictures-Its.mp3", "q_content" => "Describe the picture. \nIt's ............"],
            ['round' => 3, 'game_id' => 165, "q_audio" => $AudioDomain . $G1_L26_Speaking . "dragonfruit.mp3",  'q_image' => $l26_G165_image . "dragonfruit.png", "round_instruction" => $AudioDomain . $G1_L26_Speaking . "Describe-the-pictures-Its.mp3", "q_content" => "Describe the picture. \nIt's ............"],
            ['round' => 4, 'game_id' => 165, "q_audio" => $AudioDomain . $G1_L26_Speaking . "mango.mp3",  'q_image' => $l26_G165_image . "mango.png", "round_instruction" => $AudioDomain . $G1_L26_Speaking . "Describe-the-pictures-Its.mp3", "q_content" => "Describe the picture. \nIt's ............"],
            ['round' => 5, 'game_id' => 165, "q_audio" => $AudioDomain . $G1_L26_Speaking . "guava.mp3",  'q_image' => $l26_G165_image . "guava.png", "round_instruction" => $AudioDomain . $G1_L26_Speaking . "Describe-the-pictures-Its.mp3", "q_content" => "Describe the picture. \nIt's ............"],
            ['round' => 6, 'game_id' => 165, "q_audio" => $AudioDomain . $G1_L26_Speaking . "coconut.mp3",  'q_image' => $l26_G165_image . "coconut.png", "round_instruction" => $AudioDomain . $G1_L26_Speaking . "Describe-the-pictures-Its.mp3", "q_content" => "Describe the picture. \nIt's ............"],
            ['round' => 7, 'game_id' => 165, "q_audio" => $AudioDomain . $G1_L26_Speaking . "papaya.mp3",  'q_image' => $l26_G165_image . "papaya.png", "round_instruction" => $AudioDomain . $G1_L26_Speaking . "Describe-the-pictures-Its.mp3", "q_content" => "Describe the picture. \nIt's ............"],
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 166, 'a_content' => 'https://player.vimeo.com/video/943883699', 'isLocal' => 1]);
        ...
        $ansl27G167Content = [
            "pear", "papaya", "peach", "pineapple", "pomelo", "lime", "lemon", "lychee", "Mango", "Mangosteen", "Melon", "Olives", "Orange", "Rambutan", "Strawberry", "Watermelon"
        ];
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 172, 'a_content' => 'https://player.vimeo.com/video/943883828', 'isLocal' => 1]);
        ...
        foreach ($ansl28_G173_Content as $key) {
            DB::table('ans_n_ques')->insert([
                [
                    'game_id' => 173, 'a_content' => $key, 'a_image' => $l28_G173_image . str_replace(' ', '', $key) . ".png",
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 178, 'a_content' => 'https://player.vimeo.com/video/943883959', 'isLocal' => 1]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 179, 'a_image' => $l29_G179_image . "boy.gif", "a_audio" => $AudioDomain . $G1_L29_Read_Listen_n_Repeat_path . "Give-me-some-bananas.mp3", "a_conver" => $l29_G179_image . "some-bana.png", "background" =>  $l29_G179_image . "bg.png"],
            ['round' => 1, 'game_id' => 179, 'a_image' => $l29_G179_image . "girl.gif", "a_audio" => $AudioDomain . $G1_L29_Read_Listen_n_Repeat_path . "How-many-bananas.mp3", "a_conver" => $l29_G179_image . "how-bana.png", "background" =>  $l29_G179_image . "bg.png"],

            ['round' => 2, 'game_id' => 179, 'a_image' => $l29_G179_image . "boy.gif", "a_audio" => $AudioDomain . $G1_L29_Read_Listen_n_Repeat_path . "3-bananas.mp3", "a_conver" => $l29_G179_image . "3-bana.png", "background" =>  $l29_G179_image . "bg.png"],
            ['round' => 2, 'game_id' => 179, 'a_image' => $l29_G179_image . "girl.gif", "a_audio" => $AudioDomain . $G1_L29_Read_Listen_n_Repeat_path . "Here-you-are.mp3", "a_conver" => $l29_G179_image . "here-you-right.png", "background" =>  $l29_G179_image . "bg.png"],

            ['round' => 3, 'game_id' => 179, 'a_image' => $l29_G179_image . "boy.gif", "a_audio" => $AudioDomain . $G1_L29_Read_Listen_n_Repeat_path . "Thank-you.mp3", "a_conver" => $l29_G179_image . "thank.png", "background" =>  $l29_G179_image . "bg.png"],
            ['round' => 3, 'game_id' => 179, 'a_image' => $l29_G179_image . "girl.gif", "a_audio" => null, "a_conver" => null, "background" =>  $l29_G179_image . "bg.png"],


            ['round' => 4, 'game_id' => 179, 'a_image' => $l29_G179_image . "boy.gif", "a_audio" => $AudioDomain . $G1_L29_Read_Listen_n_Repeat_path . "Give-me-some-mangoes.mp3", "a_conver" => $l29_G179_image . "some-mango.png", "background" =>  $l29_G179_image . "bg.png"],
            ['round' => 4, 'game_id' => 179, 'a_image' => $l29_G179_image . "girl.gif", "a_audio" => $AudioDomain . $G1_L29_Read_Listen_n_Repeat_path . "How-many-mangoes.mp3", "a_conver" => $l29_G179_image . "how-mango.png", "background" =>  $l29_G179_image . "bg.png"],

            ['round' => 5, 'game_id' => 179, 'a_image' => $l29_G179_image . "boy.gif", "a_audio" => $AudioDomain . $G1_L29_Read_Listen_n_Repeat_path . "5-mangoes.mp3", "a_conver" => $l29_G179_image . "5-mango.png", "background" =>  $l29_G179_image . "bg.png"],
            ['round' => 5, 'game_id' => 179, 'a_image' => $l29_G179_image . "girl.gif", "a_audio" => $AudioDomain . $G1_L29_Read_Listen_n_Repeat_path . "Here-you-are.mp3", "a_conver" => $l29_G179_image . "here-you-right.png", "background" =>  $l29_G179_image . "bg.png"],

            ['round' => 6, 'game_id' => 179, 'a_image' => $l29_G179_image . "boy.gif", "a_audio" => $AudioDomain . $G1_L29_Read_Listen_n_Repeat_path . "Thank-you.mp3", "a_conver" => $l29_G179_image . "thank.png", "background" =>  $l29_G179_image . "bg.png"],
            ['round' => 6, 'game_id' => 179, 'a_image' => $l29_G179_image . "girl.gif", "a_audio" => null, "a_conver" => null, "background" =>  $l29_G179_image . "bg.png"],


            ['round' => 7, 'game_id' => 179, 'a_image' => $l29_G179_image . "boy.gif", "a_audio" => $AudioDomain . $G1_L29_Read_Listen_n_Repeat_path . "Please-give-me-some-oranges.mp3", "a_conver" => $l29_G179_image . "some-orange.png", "background" =>  $l29_G179_image . "bg.png"],
            ['round' => 7, 'game_id' => 179, 'a_image' => $l29_G179_image . "girl.gif", "a_audio" => $AudioDomain . $G1_L29_Read_Listen_n_Repeat_path . "How-many-oranges.mp3", "a_conver" => $l29_G179_image . "how-orange.png", "background" =>  $l29_G179_image . "bg.png"],

            ['round' => 8, 'game_id' => 179, 'a_image' => $l29_G179_image . "boy.gif", "a_audio" => $AudioDomain . $G1_L29_Read_Listen_n_Repeat_path . "7-oranges.mp3", "a_conver" => $l29_G179_image . "7-orange.png", "background" =>  $l29_G179_image . "bg.png"],
            ['round' => 8, 'game_id' => 179, 'a_image' => $l29_G179_image . "girl.gif", "a_audio" => $AudioDomain . $G1_L29_Read_Listen_n_Repeat_path . "Here-you-are.mp3", "a_conver" => $l29_G179_image . "here-you-right.png", "background" =>  $l29_G179_image . "bg.png"],

            ['round' => 9, 'game_id' => 179, 'a_image' => $l29_G179_image . "boy.gif", "a_audio" => $AudioDomain . $G1_L29_Read_Listen_n_Repeat_path . "Thank-you.mp3", "a_conver" => $l29_G179_image . "thank.png", "background" =>  $l29_G179_image . "bg.png"],
            ['round' => 9, 'game_id' => 179, 'a_image' => $l29_G179_image . "girl.gif", "a_audio" => null, "a_conver" => null, "background" =>  $l29_G179_image . "bg.png"],
        ]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            [
                'round' => 2, 'game_id' => 180, 'a_content' => "mango", 'q_image' => $l29_G180_image . "mango2" . ".png",
                'a_audio' => $AudioDomain . $G1_L29_listen_n_practice . "Give-me-2-mangoes" . ".mp3", "background" => $l29_G180_image . "bg.png"
            ],
            [
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 184, 'a_content' => 'https://player.vimeo.com/video/943884486', 'isLocal' => 1]);
        ...
        $ansl27G167Content = [
            "queen", "quiet", "quince", "room", "rain", "raincoat", "rainbow", "quail", "rabbit", "road", "rat", "rhino", "rambutan", "raspberry"
        ];
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 188,  "q_audio" => $AudioDomain . $G1_L30_Speaking . "quail.mp3", 'q_image' => $l30_G188_image . "bird.png", "round_instruction" => $AudioDomain . $G1_L30_Speaking . "SubBlock_Look-at-the-picture-and-say-a.mp3", "q_content" => "Look at the picture and say a word."],
            ['round' => 2, 'game_id' => 188,  "q_audio" => $AudioDomain . $G1_L30_Speaking . "raincoat.mp3", 'q_image' => $l30_G188_image . "raincoat.png", "round_instruction" => $AudioDomain . $G1_L30_Speaking . "SubBlock_Look-at-the-picture-and-say-a.mp3", "q_content" => "Look at the picture and say a word."],
            ['round' => 3, 'game_id' => 188,  "q_audio" => $AudioDomain . $G1_L30_Speaking . "rainbow.mp3", 'q_image' => $l30_G188_image . "rainbow.png", "round_instruction" => $AudioDomain . $G1_L30_Speaking . "SubBlock_Look-at-the-picture-and-say-a.mp3", "q_content" => "Look at the picture and say a word."],
            ['round' => 4, 'game_id' => 188,  "q_audio" => $AudioDomain . $G1_L30_Speaking . "road.mp3", 'q_image' => $l30_G188_image . "road.png", "round_instruction" => $AudioDomain . $G1_L30_Speaking . "SubBlock_Look-at-the-picture-and-say-a.mp3", "q_content" => "Look at the picture and say a word."],
            ['round' => 5, 'game_id' => 188,  "q_audio" => $AudioDomain . $G1_L30_Speaking . "rhino.mp3", 'q_image' => $l30_G188_image . "rhino.png", "round_instruction" => $AudioDomain . $G1_L30_Speaking . "SubBlock_Look-at-the-picture-and-say-a.mp3", "q_content" => "Look at the picture and say a word."],
            ['round' => 6, 'game_id' => 188,  "q_audio" => $AudioDomain . $G1_L30_Speaking . "rambutan.mp3", 'q_image' => $l30_G188_image . "rambutan.png", "round_instruction" => $AudioDomain . $G1_L30_Speaking . "SubBlock_Look-at-the-picture-and-say-a.mp3", "q_content" => "Look at the picture and say a word."],
            ['round' => 7, 'game_id' => 188,  "q_audio" => $AudioDomain . $G1_L30_Speaking . "queen.mp3", 'q_image' => $l30_G188_image . "queen.png", "round_instruction" => $AudioDomain . $G1_L30_Speaking . "SubBlock_Look-at-the-picture-and-say-a.mp3", "q_content" => "Look at the picture and say a word."],
            ['round' => 8, 'game_id' => 188,  "q_audio" => $AudioDomain . $G1_L30_Speaking . "pear.mp3", 'q_image' => $l30_G188_image . "pear.png", "round_instruction" => $AudioDomain . $G1_L30_Speaking . "SubBlock_Look-at-the-picture-and-say-a.mp3", "q_content" => "Look at the picture and say a word."],
