            ...
            <div className="mt-3">
                ...
                <div className='overflow-y-scroll h-[25rem] drop-shadow'>
                    <table className=" border  w-full border-separate rounded bg-white " >
                        ...
                        <tbody>
                            {
                                filtered.map((s) => (
                                    <tr key={s.id}>
                                        ...
                                        <td className="border px-4 py-2">{s.isAuth ? "online" : "offline"}</td>
                                        <td className="border px-4 py-2 ">
                                            <div className='flex justify-center content-center'>
                                                ...
                                                <button className="border px-2 py-1 mx-2 hover:bg-sky-700 text-white bg-sky-600 rounded-md drop-shadow " title='Edit'>
                                                    <i className="fa-solid fa-pen-to-square"></i>
                                                </button>


                                                <button className="border px-2 py-1 mx-2 hover:bg-red-600 text-white bg-red-500 rounded-md drop-shadow" title='Delete'>
                        ...
                        {/* <tbody v-else className="text-center">
                            <tr>
