...
class AnsNQueSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 3, 'game_id' => 65, "q_image" => null, "q_audio" =>  $AudioDomain . $G1_L11_reading_passage_path . "dress.mp3", 'q_content' => "dress", "q_conver" => null, 'a_content' => 1, "background" => null],
            ['round' => 3, 'game_id' => 65, "q_image" => null, "q_audio" =>  $AudioDomain . $G1_L11_reading_passage_path . "dree_ball.mp3", 'q_content' => "ball", "q_conver" => null, 'a_content' => 0, "background" => null],
            ...
            ['round' => 5, 'game_id' => 65, "q_image" => null, "q_audio" =>  $AudioDomain . $G1_L11_reading_passage_path . "pink.mp3", 'q_content' => "pink", "q_conver" => null, 'a_content' => 0, "background" => null],
            ...
            ['round' => 5, 'game_id' => 65, "q_image" => null, "q_audio" =>  $AudioDomain . $G1_L11_reading_passage_path . "blue.mp3", 'q_content' => "blue", "q_conver" => null, 'a_content' => 1, "background" => null],
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 3, 'game_id' => 112, "q_audio" => $AudioDomain . $G1_L18_Speaking . "Dont-touch-your-back.mp3", 'round_instruction' => $AudioDomain . $G1_L18_Speaking . "Look-at-the-pictures-say-a-sen" . ".mp3", 'q_image' => $l18G112image . "back.png", "q_content" => "Look at the picture and say the sentence. \nDon't touch your back."],
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 118, "q_audio" =>  $AudioDomain . $G1_L19_Speaking . "SubBlock_Touch-your-legs.mp3", "round_instruction" =>  $AudioDomain . $G1_L19_Speaking . "Look-at-the-pictures-say-a-sen" . ".mp3", 'q_image' => $l19G118image . "leg.png", "q_content" => "Touch your ____."],
            ['round' => 2, 'game_id' => 118, "q_audio" =>  $AudioDomain . $G1_L19_Speaking . "Dont-touch-your-ankle.mp3", "round_instruction" =>  $AudioDomain . $G1_L19_Speaking . "Look-at-the-pictures-say-a-sen" . ".mp3", 'q_image' => $l19G118image . "ankle.png", "q_content" => "Don't touch your ____."],
            ['round' => 3, 'game_id' => 118, "q_audio" =>  $AudioDomain . $G1_L19_Speaking . "Dont-touch-your-feet.mp3", "round_instruction" =>  $AudioDomain . $G1_L19_Speaking . "Look-at-the-pictures-say-a-sen" . ".mp3", 'q_image' => $l19G118image . "feet.png", "q_content" => "Don't touch your ____."],
            ['round' => 4, 'game_id' => 118, "q_audio" =>  $AudioDomain . $G1_L19_Speaking . "Dont-touch-your-thigh.mp3", "round_instruction" =>  $AudioDomain . $G1_L19_Speaking . "Look-at-the-pictures-say-a-sen" . ".mp3", 'q_image' => $l19G118image . "thigh.png", "q_content" => "Don't touch your ____."],
            ['round' => 5, 'game_id' => 118, "q_audio" =>  $AudioDomain . $G1_L19_Speaking . "touch-your-waist.mp3", "round_instruction" =>  $AudioDomain . $G1_L19_Speaking . "Look-at-the-pictures-say-a-sen" . ".mp3", 'q_image' => $l19G118image . "waist.png", "q_content" => "Touch your ____."],
