...
class AnsNQueSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 462, 'q_image' => $l1_G462image . "teacher.png", "q_conver" => "What is your brother?", "q_audio" => $AudioDomain . $G3_L1_practice_speaking . "what-is-your-brother" . ".mp3"],
            ['round' => 2, 'game_id' => 462, 'q_image' => $l1_G462image . "teacher.png", "q_conver" => "What is your sister?", "q_audio" => $AudioDomain . $G3_L1_practice_speaking . "what-is-your-sister" . ".mp3"],
            ['round' => 3, 'game_id' => 462, 'q_image' => $l1_G462image . "teacher.png", "q_conver" => "What are you?", "q_audio" => $AudioDomain . $G3_L1_practice_speaking . "what-are-you" . ".mp3"],
            ['round' => 4, 'game_id' => 462, 'q_image' => $l1_G462image . "teacher.png", "q_conver" => "What is your mother?", "q_audio" => $AudioDomain . $G3_L1_practice_speaking . "what-is-your-mother" . ".mp3"],
            ['round' => 5, 'game_id' => 462, 'q_image' => $l1_G462image . "teacher.png", "q_conver" => "What is your father?", "q_audio" => $AudioDomain . $G3_L1_practice_speaking . "what-is-your-father" . ".mp3"],
        ]);
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 471, "q_image" => $l2_G471image . "green-star.png", "q_audio" => $AudioDomain . $G3_L2_speaking . "SubBlock_Describe-your-family-members.mp3", "q_content" => "Describe your family members. \nWhat are they like? What do they look like?", "round_instruction" => $AudioDomain . $G3_L2_speaking . "SubBlock_Describe-your-family-members.mp3"],
        ]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 3, 'game_id' => 475,  'q_audio' =>  $AudioDomain . $G3_L3_listening . "singer" . ".mp3", "q_content" => "musian", "a_content" => 0],
        ...
        DB::table('ans_n_ques')->insert([
            ...
            // game 481
            ['round' => 1, 'game_id' => 481, 'a_image' => $l4_G481_G481_image . "mom.png", "a_audio" => $AudioDomain . $G3_L4_listen_practice . "download-song.mp3", "a_conver" => "Are you downloading a song, Cindy?", "background" =>  $l4_G481_G481_image . "bg1.jpg"],
            ['round' => 1, 'game_id' => 481, 'a_image' => $l4_G481_G481_image . "cindy.png", "a_audio" => $AudioDomain . $G3_L4_listen_practice . "yes-song.mp3", "a_conver" => "Oh, Hi mom. Yes I am. It is \nthe new Miley Cyrus's song.", "background" =>  $l4_G481_G481_image . "bg1.jpg"],

            ['round' => 2, 'game_id' => 481, 'a_image' => $l4_G481_G481_image . "mom.png", "a_audio" => $AudioDomain . $G3_L4_listen_practice . "miley-is-she.mp3", "a_conver" => "Miley Cyrus.... \nIs she Billy Ray Cyrus's daughter?", "background" =>  $l4_G481_G481_image . "bg1.jpg"],
            ['round' => 2, 'game_id' => 481, 'a_image' => $l4_G481_G481_image . "cindy.png", "a_audio" =>  $AudioDomain . $G3_L4_listen_practice . "dont-know.mp3", "a_conver" => "I don't know. Who is he?", "background" =>  $l4_G481_G481_image . "bg1.jpg"],

            ['round' => 3, 'game_id' => 481, 'a_image' => $l4_G481_G481_image . "mom.png", "a_audio" => $AudioDomain . $G3_L4_listen_practice . "he-is-singer-actor.mp3", "a_conver" => "He is a singer and actor. He is very \nhandsome.", "background" =>  $l4_G481_G481_image . "bg1.jpg"],
            ['round' => 3, 'game_id' => 481, 'a_image' => $l4_G481_G481_image . "cindy.png", "a_audio" => null, "a_conver" => null, "background" =>  $l4_G481_G481_image . "bg1.jpg"],
        ...
        $G3_L4_Game484_ans = "Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi magnam animi a rem recusandae, nobis voluptate, quas laboriosam alias natus esse delectus necessitatibus ipsum sed debitis dolorem. Repellendus, quibusdam beatae.";

        DB::table('ans_n_ques')->insert([
            ['game_id' => 484, 'a_content' => $G3_L4_Game484_ans],
        ]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 487, "q_image" => "Asporagus", "q_content" => "Fruit Vegetable", "a_content" => "Vegetable"],
        ...
        $q_content_G3_L5_Game489_img = ["carrot", "papaya", "potato", "eggplant", "watermelon", "tomato", "mango", "asporagus", "cabbage", "pineapple", "strawberry", "banana"];
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 490,  'q_audio' =>  null, "q_content" => "grape", "a_content" => 1],
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 491, "q_audio" => $AudioDomain . $G3_L5_practice_speaking . ".mp3", 'q_image' => $l5_G491image . "banana.png", "q_content" => "What is your favorite fruit?\nWhat fruit don't you like?", "round_instruction" => $AudioDomain . $G3_L5_practice_speaking . "fav-fruit" . ".mp3"],
            ['round' => 2, 'game_id' => 491, "q_audio" => $AudioDomain . $G3_L5_practice_speaking . ".mp3", 'q_image' => $l5_G491image . "carrot.png", "q_content" => "What is your favorite vegetable?\nWhat vegetable don't you like?", "round_instruction" => $AudioDomain . $G3_L5_practice_speaking . "fav-vege" . ".mp3"],
            ['round' => 3, 'game_id' => 491, "q_audio" => $AudioDomain . $G3_L5_practice_speaking . ".mp3", 'q_image' => $l5_G491image . "tomato.png", "q_content" => "What is your favorite vegetable?\nWhat vegetable don't you like?", "round_instruction" => $AudioDomain . $G3_L5_practice_speaking . "fav-vege" . ".mp3"],
            ['round' => 4, 'game_id' => 491, "q_audio" => $AudioDomain . $G3_L5_practice_speaking . ".mp3", 'q_image' => $l5_G491image . "potato.png", "q_content" => "What is your favorite vegetable?\nWhat vegetable don't you like?", "round_instruction" => $AudioDomain . $G3_L5_practice_speaking . "fav-vege" . ".mp3"],
            ['round' => 5, 'game_id' => 491, "q_audio" => $AudioDomain . $G3_L5_practice_speaking . ".mp3", 'q_image' => $l5_G491image . "mango.png", "q_content" => "What is your favorite fruit?\nWhat fruit don't you like?", "round_instruction" => $AudioDomain . $G3_L5_practice_speaking . "fav-fruit" . ".mp3"],
            ['round' => 6, 'game_id' => 491, "q_audio" => $AudioDomain . $G3_L5_practice_speaking . ".mp3", 'q_image' => $l5_G491image . "apple.png", "q_content" => "What is your favorite fruit?\nWhat fruit don't you like?", "round_instruction" => $AudioDomain . $G3_L5_practice_speaking . "fav-fruit" . ".mp3"],
        ]);
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 493,  'q_image' => $l5_G493image . "girl.png", "q_conver" => "What is your favorite fruit? \nWhat fruit don't you like?", "round_instruction" => $AudioDomain . $G2_L5_speaking . "fav-fruit.mp3", "q_audio" => $AudioDomain . $G2_L5_speaking . "fav-fruit.mp3"],
            ['round' => 2, 'game_id' => 493,  'q_image' => $l5_G493image . "girl.png", "q_conver" => "What is your favorite vegetable? \nWhat vegetable don't like?", "round_instruction" => $AudioDomain . $G2_L5_speaking . "fav-vege.mp3", "q_audio" => $AudioDomain . $G2_L5_speaking . "fav-vege.mp3"],
        ]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 497, "q_audio" => $AudioDomain . $G3_L6_reading_passage_path . "I-am-alice-I-am-eight-year-old.mp3", "q_content" => null, 'q_conver' => "I am Alice. I am 8 years old. Now I am a Grade (3) student.  I want to an athlete in the future. I like playing tennis. I am good at tennis. If I become a professional player, I will travel around the world and play tennis. I will be very happy.", 'a_content' => null, "background" => $l6_G497_image . "bg.jpg"],
            ...
            ['round' => 2, 'game_id' => 497, "q_audio" => $AudioDomain . $G3_L6_reading_passage_path . "I-am-alice-I-am-eight-year-old.mp3", "q_content" => null, 'q_conver' => "I am Alice. I am 8 years old. Now I am a Grade (3) student.  I want to an athlete in the future. I like playing tennis. I am good at tennis. If I become a professional player, I will travel around the world and play tennis. I will be very happy.", 'a_content' => null, "background" => $l6_G497_image . "bg.jpg"],
            ...
            ['round' => 3, 'game_id' => 497, "q_audio" => $AudioDomain . $G3_L6_reading_passage_path . "I-am-alice-I-am-eight-year-old.mp3", "q_content" => null, 'q_conver' => "I am Alice. I am 8 years old. Now I am a Grade (3) student.  I want to an athlete in the future. I like playing tennis. I am good at tennis. If I become a professional player, I will travel around the world and play tennis. I will be very happy.", 'a_content' => null, "background" => $l6_G497_image . "bg.jpg"],
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 498, "q_audio" => $AudioDomain . $G3_L6_practice_speaking . ".mp3", 'q_image' => $l6_G498image . "swim.png", "round_instruction" => $AudioDomain . $G3_L6_practice_speaking . "SubBlock_what-sports-and-games-are-you.mp3", "q_content" => "What sports and games are you good at? (or) aren't you good at?"],
            ['round' => 2, 'game_id' => 498, "q_audio" => $AudioDomain . $G3_L6_practice_speaking . ".mp3", 'q_image' => $l6_G498image . "basketball.png", "round_instruction" => $AudioDomain . $G3_L6_practice_speaking . "SubBlock_what-sports-and-games-are-you.mp3", "q_content" => "What sports and games are you good at? (or) aren't you good at?"],
            ['round' => 3, 'game_id' => 498, "q_audio" => $AudioDomain . $G3_L6_practice_speaking . ".mp3", 'q_image' => $l6_G498image . "tennis.png", "round_instruction" => $AudioDomain . $G3_L6_practice_speaking . "SubBlock_what-sports-and-games-are-you.mp3", "q_content" => "What sports and games are you good at? (or) aren't you good at?"],
            ['round' => 4, 'game_id' => 498, "q_audio" => $AudioDomain . $G3_L6_practice_speaking . ".mp3", 'q_image' => $l6_G498image . "boat.png", "round_instruction" => $AudioDomain . $G3_L6_practice_speaking . "SubBlock_what-sports-and-games-are-you.mp3", "q_content" => "What sports and games are you good at? (or) aren't you good at?"],
            ['round' => 5, 'game_id' => 498, "q_audio" => $AudioDomain . $G3_L6_practice_speaking . ".mp3", 'q_image' => $l6_G498image . "cycling.png", "round_instruction" => $AudioDomain . $G3_L6_practice_speaking . "SubBlock_what-sports-and-games-are-you.mp3", "q_content" => "What sports and games are you good at? (or) aren't you good at?"],
            ['round' => 6, 'game_id' => 498, "q_audio" => $AudioDomain . $G3_L6_practice_speaking . ".mp3", 'q_image' => $l6_G498image . "archery.png", "round_instruction" => $AudioDomain . $G3_L6_practice_speaking . "SubBlock_what-sports-and-games-are-you.mp3", "q_content" => "What sports and games are you good at? (or) aren't you good at?"],
        ]);
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 501, 'q_image' => $l6_G501image . "green-star.png", "q_content" => "Speak about your favorite games and sports.", "round_instruction" => $AudioDomain . $G3_L6_speaking . "SubBlock_speak-about-your-favourite-gam.mp3", "q_audio" => $AudioDomain . $G3_L6_speaking . "SubBlock_speak-about-your-favourite-gam.mp3"],
        ]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 506, "q_audio" => $AudioDomain . $G3_L7_practice_speaking . ".mp3", 'q_image' => $l7_G506image . "social-fav.png", "q_content" => "What subject are you good at?", "round_instruction" => $AudioDomain . $G3_L7_practice_speaking . "SubBlock_what-subject-are-you-good-at.mp3"],
            ['round' => 2, 'game_id' => 506, "q_audio" => $AudioDomain . $G3_L7_practice_speaking . ".mp3", 'q_image' => $l7_G506image . "phys-fav.png", "q_content" => "What subject are you good at?", "round_instruction" => $AudioDomain . $G3_L7_practice_speaking . "SubBlock_what-subject-are-you-good-at.mp3"],
            ['round' => 3, 'game_id' => 506, "q_audio" => $AudioDomain . $G3_L7_practice_speaking . ".mp3", 'q_image' => $l7_G506image . "science-fav.png", "q_content" => "What subject are you good at?", "round_instruction" => $AudioDomain . $G3_L7_practice_speaking . "SubBlock_what-subject-are-you-good-at.mp3"],
            ['round' => 4, 'game_id' => 506, "q_audio" => $AudioDomain . $G3_L7_practice_speaking . ".mp3", 'q_image' => $l7_G506image . "history-fav.png", "q_content" => "What subject are you good at?", "round_instruction" => $AudioDomain . $G3_L7_practice_speaking . "SubBlock_what-subject-are-you-good-at.mp3"],
        ...
        $G3_L8_Game512_Matching_auido = [
            ...
            'q-dance', 'q-fly-kite', 'q-ride-horse', 'q-play-guitar', 'q-swim',
            'a-swim', 'a-play-guitar', "a-dance", "a-fly-kite", 'a-ride-horse'
        ];
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 523, "q_audio" => $AudioDomain . $G3_L9_practice_speaking . "" . ".mp3", 'q_image' => $l9_G523image . "room.png", "q_content" => "Is there a TV?", "round_instruction" => $AudioDomain . $G3_L9_practice_speaking . "TV" . ".mp3"],
            ['round' => 2, 'game_id' => 523, "q_audio" => $AudioDomain . $G3_L9_practice_speaking . "" . ".mp3", 'q_image' => $l9_G523image . "room.png", "q_content" => "Are there photographs?", "round_instruction" => $AudioDomain . $G3_L9_practice_speaking . "photographs" . ".mp3"],
            ['round' => 3, 'game_id' => 523, "q_audio" => $AudioDomain . $G3_L9_practice_speaking . "" . ".mp3", 'q_image' => $l9_G523image . "room.png", "q_content" => "Is there a desk?", "round_instruction" => $AudioDomain . $G3_L9_practice_speaking . "desk" . ".mp3"],
            ['round' => 4, 'game_id' => 523, "q_audio" => $AudioDomain . $G3_L9_practice_speaking . "" . ".mp3", 'q_image' => $l9_G523image . "room.png", "q_content" => "Is there a telephone?", "round_instruction" => $AudioDomain . $G3_L9_practice_speaking . "telephone" . ".mp3"],
            ['round' => 5, 'game_id' => 523, "q_audio" => $AudioDomain . $G3_L9_practice_speaking . "" . ".mp3", 'q_image' => $l9_G523image . "room.png", "q_content" => "Are there any lamps?", "round_instruction" => $AudioDomain . $G3_L9_practice_speaking . "lamps" . ".mp3"],
            ['round' => 5, 'game_id' => 523, "q_audio" => $AudioDomain . $G3_L9_practice_speaking . "" . ".mp3", 'q_image' => $l9_G523image . "room.png", "q_content" => "Is there a DVD player?", "round_instruction" => $AudioDomain . $G3_L9_practice_speaking . "DVD-player" . ".mp3"],
        ]);
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 524, "q_image" => $l9_G524image . "green-star.png", "q_content" => "What is in your room?", "round_instruction" => $AudioDomain . $G3_L9_speaking . "SubBlock_what-is-in-your-room" . ".mp3", "q_audio" => $AudioDomain . $G3_L9_speaking . "SubBlock_what-is-in-your-room" . ".mp3"],
        ]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 7, 'game_id' => 529,  'q_audio' =>  null, "q_content" => "nest to the wall", "a_content" => 0],
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 530, "q_audio" => $AudioDomain . $G3_L10_practice_speaking . "" . ".mp3", 'q_image' => $l10_G530image . "cat.png", "q_content" => "Where is the cat?", "round_instruction" => $AudioDomain . $G3_L10_practice_speaking . "cat" . ".mp3"],
            ['round' => 2, 'game_id' => 530, "q_audio" => $AudioDomain . $G3_L10_practice_speaking . "" . ".mp3", 'q_image' => $l10_G530image . "picture.png", "q_content" => "Where are the pictures? ", "round_instruction" => $AudioDomain . $G3_L10_practice_speaking . "picture" . ".mp3"],
            ['round' => 3, 'game_id' => 530, "q_audio" => $AudioDomain . $G3_L10_practice_speaking . "" . ".mp3", 'q_image' => $l10_G530image . "book.png", "q_content" => "Where are the books?", "round_instruction" => $AudioDomain . $G3_L10_practice_speaking . "book" . ".mp3"],
            ['round' => 4, 'game_id' => 530, "q_audio" => $AudioDomain . $G3_L10_practice_speaking . "" . ".mp3", 'q_image' => $l10_G530image . "telephone.png", "q_content" => "Where is the telephone?", "round_instruction" => $AudioDomain . $G3_L10_practice_speaking . "telephone" . ".mp3"],
            ['round' => 5, 'game_id' => 530, "q_audio" => $AudioDomain . $G3_L10_practice_speaking . "" . ".mp3", 'q_image' => $l10_G530image . "TV.png", "q_content" => "Where is the TV?", "round_instruction" => $AudioDomain . $G3_L10_practice_speaking . "TV" . ".mp3"],
            ['round' => 6, 'game_id' => 530, "q_audio" => $AudioDomain . $G3_L10_practice_speaking . "" . ".mp3", 'q_image' => $l10_G530image . "sofa.png", "q_content" => "Where is the sofa?", "round_instruction" => $AudioDomain . $G3_L10_practice_speaking . "sofa" . ".mp3"],
        ]);
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 539, "q_audio" => $AudioDomain . $G3_L11_practice_speaking . "" . ".mp3", 'q_image' => $l11_G539image . "rabbit.png", "q_content" => "Do you have a rabbit? \nDo you have a squirrel?", "round_instruction" => $AudioDomain . $G3_L11_practice_speaking . "rabbit" . ".mp3"],
            ['round' => 2, 'game_id' => 539, "q_audio" => $AudioDomain . $G3_L11_practice_speaking . "" . ".mp3", 'q_image' => $l11_G539image . "duck.png", "q_content" => "Do you have a duck? \nDo you have a cat?", "round_instruction" =>  $AudioDomain . $G3_L11_practice_speaking . "duck" . ".mp3"],
            ['round' => 3, 'game_id' => 539, "q_audio" => $AudioDomain . $G3_L11_practice_speaking . "" . ".mp3", 'q_image' => $l11_G539image . "hamster.png", "q_content" => "Do you have a hamster? \nDo you have a pigeon?", "round_instruction"  => $AudioDomain . $G3_L11_practice_speaking . "hamster" . ".mp3"],
            ['round' => 4, 'game_id' => 539, "q_audio" => $AudioDomain . $G3_L11_practice_speaking . "" . ".mp3", 'q_image' => $l11_G539image . "cat.png", "q_content" => "Do you have a cat? \nDo you have a spider?", "round_instruction" => $AudioDomain . $G3_L11_practice_speaking . "cat" . ".mp3"],
            ['round' => 5, 'game_id' => 539, "q_audio" => $AudioDomain . $G3_L11_practice_speaking . "" . ".mp3", 'q_image' => $l11_G539image . "dog.png", "q_content" => "Do you have a dog? \nDo you have a mouse?", "round_instruction" => $AudioDomain . $G3_L11_practice_speaking . "dog" . ".mp3"],
        ]);
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 540, "q_image" => $l11_G540image . "green-star.png", "q_content" => "Do you have a pet? Please talk about it.", "round_instruction" => $AudioDomain . $G3_L11_speaking . "SubBlock_do-you-have-a-pet-please-talk" . ".mp3", "q_audio" => $AudioDomain . $G3_L11_speaking . "SubBlock_do-you-have-a-pet-please-talk" . ".mp3"],
        ]);
        ...
        ////////////////////////////////////////////////////////
        ////    Grade 3  Lesson 12 Game 542 (  Vocabulary  )
        ////////////////////////////////////////////////////////

        $l12_G542_image = $domain . "/storage/images/Grade_3/lesson_12/vocab/";
        ...
        foreach ($ans_G542 as $key) {
            DB::table('ans_n_ques')->insert([
                [
                    'game_id' => 542, 'a_content' => $key, 'a_image' => $l12_G542_image . str_replace(' ', '-',  $key) . ".png",
        ...
        ////////////////////////////////////////////////////////
        ////    Grade 3  Lesson 12 Game 543 ( Arrange Letter )
        ////////////////////////////////////////////////////////

        $G3_L12_arrange_letter = "Grade_3/" . "Lesson_12/" . "arrange_letter/";
        $l12_G543_image = $domain . "/storage/images/Grade_3/lesson_12/arrange_letter/";
        ...
        for ($i = 0; $i < count($q_G543); $i++) {
            foreach ($q_G543[$i] as $j) {
                DB::table('ans_n_ques')->insert([
                    ['round' => $i + 1, 'game_id' => 543, 'q_content' => $j, 'q_audio' => $AudioDomain . $G3_L12_arrange_letter . strtoupper($j) . ".mp3"],
                ]);
            }
            DB::table('ans_n_ques')->insert([
                [
                    'round' => $i + 1, 'game_id' => 543,
                    'q_image' => $l12_G543_image . str_replace(' ', '', strtolower($a_G543[$G543_Index])) . ".png",
                    'a_audio' => $AudioDomain . $G3_L12_arrange_letter . strtolower($a_G543[$G543_Index]) . ".mp3",
                    'a_content' => $a_G543[$G543_Index],
                ],
            ]);
            $G543_Index++;
        }
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 546, "q_audio" => $AudioDomain . $G3_L12_practice_speaking . "" . ".mp3", 'q_image' => $l12_G546image . "polar-bear.png", "q_content" => "Do you love polar bears? ", "round_instruction" => $AudioDomain . $G3_L12_practice_speaking . "polar-bear" . ".mp3"],
            ['round' => 2, 'game_id' => 546, "q_audio" => $AudioDomain . $G3_L12_practice_speaking . "" . ".mp3", 'q_image' => $l12_G546image . "crocodile.png", "q_content" => "Do you love crocodiles?", "round_instruction" => $AudioDomain . $G3_L12_practice_speaking . "crocodiles" . ".mp3"],
            ['round' => 3, 'game_id' => 546, "q_audio" => $AudioDomain . $G3_L12_practice_speaking . "" . ".mp3", 'q_image' => $l12_G546image . "parrot.png", "q_content" => "Do you love parrots?", "round_instruction" => $AudioDomain . $G3_L12_practice_speaking . "parrots" . ".mp3"],
            ['round' => 4, 'game_id' => 546, "q_audio" => $AudioDomain . $G3_L12_practice_speaking . "" . ".mp3", 'q_image' => $l12_G546image . "snake.png", "q_content" => "Do you love snakes?", "round_instruction" => $AudioDomain . $G3_L12_practice_speaking . "snakes" . ".mp3"],
            ['round' => 5, 'game_id' => 546, "q_audio" => $AudioDomain . $G3_L12_practice_speaking . "" . ".mp3", 'q_image' => $l12_G546image . "elephants.png", "q_content" => "Does Peter love elephants?", "round_instruction" => $AudioDomain . $G3_L12_practice_speaking . "elephants" . ".mp3"],
            ['round' => 6, 'game_id' => 546, "q_audio" => $AudioDomain . $G3_L12_practice_speaking . "" . ".mp3", 'q_image' => $l12_G546image . "panda-bear.png", "q_content" => "Does James love Panda Bears?", "round_instruction" => $AudioDomain . $G3_L12_practice_speaking . "panda-bear" . ".mp3"],
            ['round' => 7, 'game_id' => 546, "q_audio" => $AudioDomain . $G3_L12_practice_speaking . "" . ".mp3", 'q_image' => $l12_G546image . "monkey.png", "q_content" => "Do they love monkeys?", "round_instruction" => $AudioDomain . $G3_L12_practice_speaking . "monkeys" . ".mp3"],
            ['round' => 8, 'game_id' => 546, "q_audio" => $AudioDomain . $G3_L12_practice_speaking . "" . ".mp3", 'q_image' => $l12_G546image . "lions.png", "q_content" => "Do you love lions?", "round_instruction" => $AudioDomain . $G3_L12_practice_speaking . "lions" . ".mp3"],
        ]);
        ...
        for ($i = 0; $i < count($q_G552); $i++) {
            ...
            DB::table('ans_n_ques')->insert([
                [
                    ...
                    'a_audio' => $AudioDomain . $G3_L9_language_n_practice . strtolower($audio_img_G552[$G552_Index]) . ".mp3",
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 555, "q_audio" => $AudioDomain . $G3_L13_practice_speaking . "" . ".mp3", 'q_image' => $l13_G555image . "TV.png", "q_content" => "Where is the TV in your home?", "round_instruction" => $AudioDomain . $G3_L13_practice_speaking . "TV" . ".mp3"],
            ['round' => 2, 'game_id' => 555, "q_audio" => $AudioDomain . $G3_L13_practice_speaking . "" . ".mp3", 'q_image' => $l13_G555image . "bed.png", "q_content" => "Where is the bed in your home?", "round_instruction" => $AudioDomain . $G3_L13_practice_speaking . "bed" . ".mp3"],
            ['round' => 3, 'game_id' => 555, "q_audio" => $AudioDomain . $G3_L13_practice_speaking . "" . ".mp3", 'q_image' => $l13_G555image . "bathtub.png", "q_content" => "Where is the bathtub in your home?", "round_instruction" => $AudioDomain . $G3_L13_practice_speaking . "bathtub" . ".mp3"],
            ['round' => 4, 'game_id' => 555, "q_audio" => $AudioDomain . $G3_L13_practice_speaking . "" . ".mp3", 'q_image' => $l13_G555image . "sofa.png", "q_content" => "Where is the sofa in your home?", "round_instruction" => $AudioDomain . $G3_L13_practice_speaking . "sofa" . ".mp3"],
            ['round' => 5, 'game_id' => 555, "q_audio" => $AudioDomain . $G3_L13_practice_speaking . "" . ".mp3", 'q_image' => $l13_G555image . "stove.png", "q_content" => "Where is the stove in your home?", "round_instruction" => $AudioDomain . $G3_L13_practice_speaking . "stove" . ".mp3"],
        ]);
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 562, "q_audio"  => $AudioDomain . $G3_L14_practice_speaking . "" . ".mp3", 'q_image' => $l14_G562image . "steak.png", "q_content" => "Do you want steak?", "round_instruction" => $AudioDomain . $G3_L14_practice_speaking . "steak" . ".mp3"],
            ['round' => 2, 'game_id' => 562, "q_audio"  => $AudioDomain . $G3_L14_practice_speaking . "" . ".mp3", 'q_image' => $l14_G562image . "fried-chicken.png", "q_content" => "Do you want fied chicken?", "round_instruction" => $AudioDomain . $G3_L14_practice_speaking . "fried-chicken" . ".mp3"],
            ['round' => 3, 'game_id' => 562, "q_audio"  => $AudioDomain . $G3_L14_practice_speaking . "" . ".mp3", 'q_image' => $l14_G562image . "salad.png", "q_content" => "Does she want fruit salad?", "round_instruction" => $AudioDomain . $G3_L14_practice_speaking . "salad" . ".mp3"],
            ['round' => 4, 'game_id' => 562, "q_audio"  => $AudioDomain . $G3_L14_practice_speaking . "" . ".mp3", 'q_image' => $l14_G562image . "yogurt.png", "q_content" => "Does she want yogurt?", "round_instruction" => $AudioDomain . $G3_L14_practice_speaking . "yogurt" . ".mp3"],
            ['round' => 5, 'game_id' => 562, "q_audio"  => $AudioDomain . $G3_L14_practice_speaking . "" . ".mp3", 'q_image' => $l14_G562image . "pancake.png", "q_content" => "Do they want pancakes?", "round_instruction" => $AudioDomain . $G3_L14_practice_speaking . "pancakes" . ".mp3"],
            ['round' => 6, 'game_id' => 562, "q_audio"  => $AudioDomain . $G3_L14_practice_speaking . "" . ".mp3", 'q_image' => $l14_G562image . "ham.png", "q_content" => "Do you want ham?", "round_instruction" => $AudioDomain . $G3_L14_practice_speaking . "ham" . ".mp3"],
            ['round' => 7, 'game_id' => 562, "q_audio"  => $AudioDomain . $G3_L14_practice_speaking . "" . ".mp3", 'q_image' => $l14_G562image . "omelet.png", "q_content" => "Do you want an omelet?", "round_instruction" => $AudioDomain . $G3_L14_practice_speaking . "omelet" . ".mp3"],
            ['round' => 8, 'game_id' => 562, "q_audio"  => $AudioDomain . $G3_L14_practice_speaking . "" . ".mp3", 'q_image' => $l14_G562image . "spaghetti.png", "q_content" => "Do you want spaghetti?", "round_instruction" => $AudioDomain . $G3_L14_practice_speaking . "spaghetti" . ".mp3"],
        ]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            [
                'round' => 1, 'game_id' => 563, "q_audio" => $AudioDomain . $G3_L14_reading_passage_path . "janes_toby.mp3", "q_content" => null,
                ...
                'a_content' => "Janes: Toby:", "background" => $l14_G563_image . "bg.jpg"
            ],
            ...
            [
                'round' => 2, 'game_id' => 563, "q_audio" => $AudioDomain . $G3_L14_reading_passage_path . "janes_toby.mp3", "q_content" => null,
                'q_conver' => "What is your favorite food? \nMy favorite food is steak. I like fruit salad for breakfast. I like fried chicken and rice for lunch and dinner. But I don't like fish. What about you?  \nI don't like steak. My favorite food is hamburger. I also like spaghetti. They are the best. I don't eat vegetables a lot. I don't like fish either",
                'a_content' => "Janes: Toby:", "background" => $l14_G563_image . "bg.jpg"
            ],
            ...
            [
                'round' => 3, 'game_id' => 563, "q_audio" => $AudioDomain . $G3_L14_reading_passage_path . "janes_toby.mp3", "q_content" => null,
                'q_conver' => "What is your favorite food? \nMy favorite food is steak. I like fruit salad for breakfast. I like fried chicken and rice for lunch and dinner. But I don't like fish. What about you?  \nI don't like steak. My favorite food is hamburger. I also like spaghetti. They are the best. I don't eat vegetables a lot. I don't like fish either",
                'a_content' => "Janes: Toby:", "background" => $l14_G563_image . "bg.jpg"
            ],
            ...
            [
                'round' => 4, 'game_id' => 563, "q_audio" => $AudioDomain . $G3_L14_reading_passage_path . "janes_toby.mp3", "q_content" => null,
                'q_conver' => "What is your favorite food? \nMy favorite food is steak. I like fruit salad for breakfast. I like fried chicken and rice for lunch and dinner. But I don't like fish. What about you?  \nI don't like steak. My favorite food is hamburger. I also like spaghetti. They are the best. I don't eat vegetables a lot. I don't like fish either",
                'a_content' => "Janes: Toby:", "background" => $l14_G563_image . "bg.jpg"
            ],
            ...
            [
                'round' => 5, 'game_id' => 563, "q_audio" => $AudioDomain . $G3_L14_reading_passage_path . "janes_toby.mp3", "q_content" => null,
                'q_conver' => "What is your favorite food? \nMy favorite food is steak. I like fruit salad for breakfast. I like fried chicken and rice for lunch and dinner. But I don't like fish. What about you?  \nI don't like steak. My favorite food is hamburger. I also like spaghetti. They are the best. I don't eat vegetables a lot. I don't like fish either",
                'a_content' => "Janes: Toby:", "background" => $l14_G563_image . "bg.jpg"
            ],
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 568,  'q_audio' =>  $AudioDomain . $G3_L15_listening . "house" . ".mp3", "q_content" => "Yes", "q_conver" => "The house is small", "a_content" => 0],
            ['round' => 1, 'game_id' => 568,  'q_audio' =>  null, "q_content" => "No", "q_conver" => null, "a_content" => 1],

            ['round' => 2, 'game_id' => 568,  'q_audio' =>  $AudioDomain . $G3_L15_listening . "bedroom" . ".mp3", "q_content" => "Yes", "q_conver" => "There are five bedrooms", "a_content" => 0],
            ['round' => 2, 'game_id' => 568,  'q_audio' =>  null, "q_content" => "No", "q_conver" => null, "a_content" => 1],

            ['round' => 3, 'game_id' => 568,  'q_audio' =>  $AudioDomain . $G3_L15_listening . "fav-room" . ".mp3", "q_content" => "Yes", "q_conver" => "Her favorite room is blue", "a_content" => 0],
            ['round' => 3, 'game_id' => 568,  'q_audio' =>  null, "q_content" => "No", "q_conver" => null, "a_content" => 1],

            ['round' => 4, 'game_id' => 568,  'q_audio' =>  $AudioDomain . $G3_L15_listening . "bookshelf" . ".mp3", "q_content" => "Yes", "q_conver" => "There isn't a bookshelf in her bedroom", "a_content" => 1],
            ['round' => 4, 'game_id' => 568,  'q_audio' =>  null, "q_content" => "No", "q_conver" => null, "a_content" => 0],

            ['round' => 5, 'game_id' => 568,  'q_audio' =>  $AudioDomain . $G3_L15_listening . "book" . ".mp3", "q_content" => "Yes", "q_conver" => "There aren't any books in the room", "a_content" => 0],
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 569, "q_audio" => $AudioDomain . $G3_L15_practice_speaking . "" . ".mp3", 'q_image' => $l15_G569image . "green-star.png", "q_content" => "Are there any flowers in your house?", "round_instruction" => $AudioDomain . $G3_L15_practice_speaking . "flowers" . ".mp3"],
            ['round' => 2, 'game_id' => 569, "q_audio" => $AudioDomain . $G3_L15_practice_speaking . "" . ".mp3", 'q_image' => $l15_G569image . "green-star.png", "q_content" => "Is there a bike in your house?", "round_instruction" => $AudioDomain . $G3_L15_practice_speaking . "bike" . ".mp3"],
            ['round' => 3, 'game_id' => 569, "q_audio" => $AudioDomain . $G3_L15_practice_speaking . "" . ".mp3", 'q_image' => $l15_G569image . "green-star.png", "q_content" => "Are there any fans in your house?", "round_instruction" => $AudioDomain . $G3_L15_practice_speaking . "fans" . ".mp3"],
            ['round' => 4, 'game_id' => 569, "q_audio" => $AudioDomain . $G3_L15_practice_speaking . "" . ".mp3", 'q_image' => $l15_G569image . "green-star.png", "q_content" => "Is there a bookshelf in your bedroom?", "round_instruction" => $AudioDomain . $G3_L15_practice_speaking . "bookshelf" . ".mp3"],
            ['round' => 5, 'game_id' => 569, "q_audio" => $AudioDomain . $G3_L15_practice_speaking . "" . ".mp3", 'q_image' => $l15_G569image . "green-star.png", "q_content" => "Is there a closet in your bedroom?", "round_instruction" => $AudioDomain . $G3_L15_practice_speaking . "closet" . ".mp3"],
            ['round' => 5, 'game_id' => 569, "q_audio" => $AudioDomain . $G3_L15_practice_speaking . "" . ".mp3", 'q_image' => $l15_G569image . "green-star.png", "q_content" => "Are there any pillows in your bedroom?", "round_instruction" => $AudioDomain . $G3_L15_practice_speaking . "pillows" . ".mp3"],
            ['round' => 5, 'game_id' => 569, "q_audio" => $AudioDomain . $G3_L15_practice_speaking . "" . ".mp3", 'q_image' => $l15_G569image . "green-star.png", "q_content" => "Is there an alarm clock in your bedroom?", "round_instruction" => $AudioDomain . $G3_L15_practice_speaking . "alarm-clock" . ".mp3"],
        ]);
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 575, "q_audio" => $AudioDomain . $G3_L16_practice_speaking . "" . ".mp3", 'q_image' => $l16_G575image . "door.png", "q_content" => "What is the object? What is the shape? \nHow many objects are there?", "round_instruction" => $AudioDomain . $G3_L16_practice_speaking . "What-is-the-object" . ".mp3"],
            ['round' => 2, 'game_id' => 575, "q_audio" => $AudioDomain . $G3_L16_practice_speaking . "" . ".mp3", 'q_image' => $l16_G575image . "pizza.png", "q_content" => "What is the object? What is the shape? \nHow many objects are there?", "round_instruction" => $AudioDomain . $G3_L16_practice_speaking . "What-is-the-object" . ".mp3"],
            ['round' => 3, 'game_id' => 575, "q_audio" => $AudioDomain . $G3_L16_practice_speaking . "" . ".mp3", 'q_image' => $l16_G575image . "ball.png", "q_content" => "What is the object? What is the shape? \nHow many objects are there?", "round_instruction" => $AudioDomain . $G3_L16_practice_speaking . "What-is-the-object" . ".mp3"],
            ['round' => 4, 'game_id' => 575, "q_audio" => $AudioDomain . $G3_L16_practice_speaking . "" . ".mp3", 'q_image' => $l16_G575image . "star.png", "q_content" => "What is the object? What is the shape? \nHow many objects are there?", "round_instruction" => $AudioDomain . $G3_L16_practice_speaking . "What-is-the-object" . ".mp3"],
            ['round' => 5, 'game_id' => 575, "q_audio" => $AudioDomain . $G3_L16_practice_speaking . "" . ".mp3", 'q_image' => $l16_G575image . "picture.png", "q_content" => "What is the object? What is the shape? \nHow many objects are there?", "round_instruction" => $AudioDomain . $G3_L16_practice_speaking . "What-is-the-object" . ".mp3"],
            ['round' => 6, 'game_id' => 575, "q_audio" => $AudioDomain . $G3_L16_practice_speaking . "" . ".mp3", 'q_image' => $l16_G575image . "clock.png", "q_content" => "What is the object? What is the shape? \nHow many objects are there?", "round_instruction" => $AudioDomain . $G3_L16_practice_speaking . "What-is-the-object" . ".mp3"],
        ]);
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, "q_audio" => $AudioDomain . $G3_L17_practice_speaking . "" . ".mp3", 'game_id' => 584, 'q_image' => $l17_G584image . "circle.png", "q_content" => "How many circles are there? \nWhat colors are they?", "round_instruction" => $AudioDomain . $G3_L17_practice_speaking . "circles" . ".mp3"],
            ['round' => 2, "q_audio" => $AudioDomain . $G3_L17_practice_speaking . "" . ".mp3", 'game_id' => 584, 'q_image' => $l17_G584image . "triangle.png", "q_content" => "How many triangles are there? \nWhat colors are they?", "round_instruction" => $AudioDomain . $G3_L17_practice_speaking . "triangles" . ".mp3"],
            ['round' => 3, "q_audio" => $AudioDomain . $G3_L17_practice_speaking . "" . ".mp3", 'game_id' => 584, 'q_image' => $l17_G584image . "oval.png", "q_content" => "How many ovals are there? \nWhat colors are they?", "round_instruction" => $AudioDomain . $G3_L17_practice_speaking . "ovals" . ".mp3"],
            ['round' => 4, "q_audio" => $AudioDomain . $G3_L17_practice_speaking . "" . ".mp3", 'game_id' => 584, 'q_image' => $l17_G584image . "heart.png", "q_content" => "How many hearts are there? \nWhat colors are they?", "round_instruction" => $AudioDomain . $G3_L17_practice_speaking . "hearts" . ".mp3"],
        ]);
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 590, "q_audio" => $AudioDomain . $G3_18_practice_speaking . "" . ".mp3", 'q_image' => $l18_G590image . "class.png", "q_content" => "How many girls are there in your classroom?", "round_instruction" => $AudioDomain . $G3_18_practice_speaking . "girls" . ".mp3"],
            ['round' => 2, 'game_id' => 590, "q_audio" => $AudioDomain . $G3_18_practice_speaking . "" . ".mp3", 'q_image' => $l18_G590image . "class.png", "q_content" => "How many teachers are there in your school?", "round_instruction" => $AudioDomain . $G3_18_practice_speaking . "teachers" . ".mp3"],
            ['round' => 3, 'game_id' => 590, "q_audio" => $AudioDomain . $G3_18_practice_speaking . "" . ".mp3", 'q_image' => $l18_G590image . "school.png", "q_content" => "How many boys are there in your class?", "round_instruction" => $AudioDomain . $G3_18_practice_speaking . "boys" . ".mp3"],
            ['round' => 4, 'game_id' => 590, "q_audio" => $AudioDomain . $G3_18_practice_speaking . "" . ".mp3", 'q_image' => $l18_G590image . "class.png", "q_content" => "How many students are there in your classroom?", "round_instruction" => $AudioDomain . $G3_18_practice_speaking . "students" . ".mp3"],
        ]);
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 605, "q_audio" => $AudioDomain . $G3_L20_practice_speaking . "" . ".mp3", 'q_image' => $l20_G605image . "town-like.png", "q_content" => "Has your town got a library?", "round_instruction" => $AudioDomain . $G3_L20_practice_speaking . "library" . ".mp3"],
            ['round' => 2, 'game_id' => 605, "q_audio" => $AudioDomain . $G3_L20_practice_speaking . "" . ".mp3", 'q_image' => $l20_G605image . "town-dislike.png", "q_content" => "Has your town got a laundromat?", "round_instruction" => $AudioDomain . $G3_L20_practice_speaking . "laundromat" . ".mp3"],
            ['round' => 3, 'game_id' => 605, "q_audio" => $AudioDomain . $G3_L20_practice_speaking . "" . ".mp3", 'q_image' => $l20_G605image . "town-like.png", "q_content" => "Has your town got a hotel?", "round_instruction" => $AudioDomain . $G3_L20_practice_speaking . "hotel" . ".mp3"],
            ['round' => 4, 'game_id' => 605, "q_audio" => $AudioDomain . $G3_L20_practice_speaking . "" . ".mp3", 'q_image' => $l20_G605image . "town-dislike.png", "q_content" => "Has your town got a zoo?", "round_instruction" => $AudioDomain . $G3_L20_practice_speaking . "zoo" . ".mp3"],
            ['round' => 5, 'game_id' => 605, "q_audio" => $AudioDomain . $G3_L20_practice_speaking . "" . ".mp3", 'q_image' => $l20_G605image . "town-like.png", "q_content" => "Has your town got a clinic?", "round_instruction" => $AudioDomain . $G3_L20_practice_speaking . "clinic" . ".mp3"],
            ['round' => 6, 'game_id' => 605, "q_audio" => $AudioDomain . $G3_L20_practice_speaking . "" . ".mp3", 'q_image' => $l20_G605image . "town-like.png", "q_content" => "Has your town got a bookstore?", "round_instruction" => $AudioDomain . $G3_L20_practice_speaking . "bookstore" . ".mp3"],
            ['round' => 7, 'game_id' => 605, "q_audio" => $AudioDomain . $G3_L20_practice_speaking . "" . ".mp3", 'q_image' => $l20_G605image . "town-dislike.png", "q_content" => "Has your town got a post office?", "round_instruction" => $AudioDomain . $G3_L20_practice_speaking . "post-office" . ".mp3"],
            ['round' => 8, 'game_id' => 605, "q_audio" => $AudioDomain . $G3_L20_practice_speaking . "" . ".mp3", 'q_image' => $l20_G605image . "town-like.png", "q_content" => "Has your town got a park?", "round_instruction" => $AudioDomain . $G3_L20_practice_speaking . "park" . ".mp3"],
        ]);
