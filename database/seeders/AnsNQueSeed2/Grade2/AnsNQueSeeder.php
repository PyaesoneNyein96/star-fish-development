...
class AnsNQueSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 252, 'a_content' => '943889618', 'isLocal' => 1]);
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 253, 'a_image' => $l1G253image . "jane.gif", "a_audio" => $AudioDomain . $G2_L1_pronoun . "Whats-your-name-girl.mp3", "a_conver" => $l1G253image . "what-name.png", "background" =>  $l1G253image . "bg.jpg"],
            ['round' => 1, 'game_id' => 253, 'a_image' => $l1G253image . "jack.gif", "a_audio" => $AudioDomain . $G2_L1_pronoun . "My-names-Jack.mp3", "a_conver" => $l1G253image . "jack-text.png", "background" =>  $l1G253image . "bg.jpg"],

            ['round' => 1, 'game_id' => 253, 'a_image' => $l1G253image . "rosy.gif", "a_audio" => $AudioDomain . $G2_L1_pronoun . "Whats-your-name-girl.mp3", "a_conver" => $l1G253image . "what-name.png", "background" =>  $l1G253image . "bg.jpg"],
            ['round' => 1, 'game_id' => 253, 'a_image' => $l1G253image . "chris.gif", "a_audio" => $AudioDomain . $G2_L1_pronoun . "My-names-Chris.mp3", "a_conver" => $l1G253image . "chris-text.png", "background" =>  $l1G253image . "bg.jpg"],

            ['round' => 2, 'game_id' => 253, 'a_image' => $l1G253image . "jack.gif", "a_audio" => $AudioDomain . $G2_L1_pronoun . "Whats-your-name.mp3", "a_conver" => $l1G253image . "what-name.png", "background" =>  $l1G253image . "bg.jpg"],
            ['round' => 2, 'game_id' => 253, 'a_image' => $l1G253image . "jane.gif", "a_audio" => $AudioDomain . $G2_L1_pronoun . "My-names-Jane.mp3", "a_conver" => $l1G253image . "jane-text.png", "background" =>  $l1G253image . "bg.jpg"],

            ['round' => 2, 'game_id' => 253, 'a_image' => $l1G253image . "chris.gif", "a_audio" => $AudioDomain . $G2_L1_pronoun . "Whats-your-name.mp3", "a_conver" => $l1G253image . "what-name.png", "background" =>  $l1G253image . "bg.jpg"],
            ['round' => 2, 'game_id' => 253, 'a_image' => $l1G253image . "rosy.gif", "a_audio" => $AudioDomain . $G2_L1_pronoun . "My-names-Rosy.mp3", "a_conver" => $l1G253image . "rosy-text.png", "background" =>  $l1G253image . "bg.jpg"],
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 254,  "q_audio" => $AudioDomain . $G2_L1_practice_speaking . "Whats-your-name-girl.mp3", 'q_image' => $l1_G254image . "teacher_chara.png", "q_conver" => $l1_G254image . "small_what-name.png"],
        ]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 2, 'game_id' => 255, 'a_image' => $l1_G255image . "jane.gif", "a_audio" => $AudioDomain . $G2_L1_listen_n_practice . "Hello-my-names-Jane.mp3", "a_conver" => $l1_G255image .  "jane-what.png", "background" =>  $l1_G255image . "bg.png"],
            ['round' => 2, 'game_id' => 255, 'a_image' => $l1_G255image . "chris.gif", "a_audio" => $AudioDomain . $G2_L1_listen_n_practice . "Hi-my-names-Chris-Im-Chris.mp3", "a_conver" => $l1_G255image .  "chris-hi.png", "background" =>  $l1_G255image . "bg.png"],

            ['round' => 3, 'game_id' => 255, 'a_image' => $l1_G255image . "rosy.gif", "a_audio" => $AudioDomain . $G2_L1_listen_n_practice . "Hello-my-names-Rosy-Whats.mp3", "a_conver" => $l1_G255image .  "rosy-what.png", "background" =>  $l1_G255image . "bg.png"],
            ['round' => 3, 'game_id' => 255, 'a_image' => $l1_G255image . "jane.gif", "a_audio" => $AudioDomain . $G2_L1_listen_n_practice . "Hi-my-names-Jane-Im-Jane.mp3", "a_conver" => $l1_G255image .  "hi-jane.png", "background" =>  $l1_G255image . "bg.png"],
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 5, 'game_id' => 255, 'a_image' => $l1_G255image . "jack.gif", "a_audio" => $AudioDomain . $G2_L1_listen_n_practice . "Hello-my-names-Jack-Whats.mp3", "a_conver" => $l1_G255image .  "jack-what.png", "background" =>  $l1_G255image . "bg.png"],
            ['round' => 5, 'game_id' => 255, 'a_image' => $l1_G255image . "jane.gif", "a_audio" =>  $AudioDomain . $G2_L1_listen_n_practice . "Hi-my-names-Jane.mp3", "a_conver" => $l1_G255image .  "jane-text.png", "background" =>  $l1_G255image . "bg.png"],
            ['round' => 5, 'game_id' => 255, 'a_image' => $l1_G255image . "rosy.gif", "a_audio" => $AudioDomain . $G2_L1_listen_n_practice . "Hello-Jane-Shes-Rosy.mp3", "a_conver" => $l1_G255image .  "jane-rosy.png", "background" =>  $l1_G255image . "bg.png"],

            ['round' => 6, 'game_id' => 255, 'a_image' => $l1_G255image . "jane.gif", "a_audio" => $AudioDomain . $G2_L1_listen_n_practice . "Hello-my-names-Jane.mp3", "a_conver" => $l1_G255image .  "jane-what.png", "background" =>  $l1_G255image . "bg.png"],
            ['round' => 6, 'game_id' => 255, 'a_image' => $l1_G255image . "rosy.gif", "a_audio" =>  $AudioDomain . $G2_L1_listen_n_practice . "Hi-my-names-Rosy-Im-Rosy.mp3", "a_conver" => $l1_G255image .  "hi-rosy-text.png", "background" =>  $l1_G255image . "bg.png"],
            ['round' => 6, 'game_id' => 255, 'a_image' => $l1_G255image . "chris.gif", "a_audio" => $AudioDomain . $G2_L1_listen_n_practice . "Hello-rosy-Hes-Chris.mp3", "a_conver" => $l1_G255image .  "rosy-chris.png", "background" =>  $l1_G255image . "bg.png"],
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 257,  'round_instruction' => $AudioDomain . $l1_G257_image . "lets-introduce-yourself-friends.mp3", 'q_audio' => $AudioDomain . $G2_L1_Speaking . "hello-i-am-rosy" . ".mp3", 'q_image' => $l1_G257_image . "rosy.png", "q_content" => "Lets introduce yourself and your friends. \n\n Hello, I am Rosy. What’s your name? Introduce me your friends, please. \n Hi, my name is _____________ . \n He is______________. \n  She is______________. \n Nice to meet you!"],

        ]);

        //////////////////////////////////////////////////////////////
        ////    Grade 2  Lesson 2 Game 258 ( video )
        //////////////////////////////////////////////////////////////


        DB::table('ans_n_ques')->insert(['game_id' => 258, 'a_content' => '943889705', 'isLocal' => 1]);
        DB::table('ans_n_ques')->insert(['game_id' => 258, 'a_content' => 'lesson_2_video_global', 'isLocal' => 0]);
        ...
        $ans_G259 = [
            "Airplane", "Alligator", "Angel", "Animal",  "Ant", "Apple", "Arm", "Arrow", "Ball", "Banana", "Bicycle", "Boat", "Boy", "Bread"
        ];
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 260, 'q_audio' =>  $AudioDomain . $G2_L2_trace_word . "angel" . ".mp3", 'q_content' =>  null, 'q_image' => $l2_G260_image . "angel" . ".png", "a_image" => null, "a_extra" => null, 'a_content' => "angel"],
            ['round' => 1, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $A_Z_traceword . "A" . ".png", 'q_image' => null, "a_image" => $A_Z_success . "A.png", "a_extra" => 3, 'a_content' => "A"],
            ['round' => 1, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $a_z_traceword . "n" . ".png", 'q_image' => null, "a_image" => $a_z_success . "n.png", "a_extra" => 2, 'a_content' => "n"],
            ['round' => 1, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $a_z_traceword . "g" . ".png", 'q_image' => null, "a_image" => $a_z_success . "g.png", "a_extra" => 2, 'a_content' => "g"],
            ['round' => 1, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $a_z_traceword . "e" . ".png", 'q_image' => null, "a_image" => $a_z_success . "e.png", "a_extra" => 2, 'a_content' => "e"],
            ['round' => 1, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $a_z_traceword . "l" . ".png", 'q_image' => null, "a_image" => $a_z_success . "l.png", "a_extra" => 1, 'a_content' => "l"],


            ['round' => 2, 'game_id' => 260, 'q_audio' =>  $AudioDomain . $G2_L2_trace_word . "arm" . ".mp3", 'q_content' =>  null, 'q_image' => $l2_G260_image . "arm" . ".png", "a_image" => null, "a_extra" => null, 'a_content' => "arm"],
            ['round' => 2, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $A_Z_traceword . "A" . ".png", 'q_image' => null, "a_image" => $A_Z_success . "A.png", "a_extra" => 3, 'a_content' => "A"],
            ['round' => 2, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $a_z_traceword . "r" . ".png", 'q_image' => null, "a_image" => $a_z_success . "r.png", "a_extra" => 2, 'a_content' => "r"],
            ['round' => 2, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $a_z_traceword . "m" . ".png", 'q_image' => null, "a_image" => $a_z_success . "m.png", "a_extra" => 3, 'a_content' => "m"],


            ['round' => 3, 'game_id' => 260, 'q_audio' =>  $AudioDomain . $G2_L2_trace_word . "ball" . ".mp3", 'q_content' =>  null, 'q_image' => $l2_G260_image . "ball" . ".png", "a_image" => null, "a_extra" => null, 'a_content' => "ball"],
            ['round' => 3, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $A_Z_traceword . "B" . ".png", 'q_image' => null, "a_image" => $A_Z_success . "B.png", "a_extra" => 3, 'a_content' => "B"],
            ['round' => 3, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $a_z_traceword . "a" . ".png", 'q_image' => null, "a_image" => $a_z_success . "a.png", "a_extra" => 2, 'a_content' => "a"],
            ['round' => 3, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $a_z_traceword . "l" . ".png", 'q_image' => null, "a_image" => $a_z_success . "l.png", "a_extra" => 1, 'a_content' => "l"],
            ['round' => 3, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $a_z_traceword . "l" . ".png", 'q_image' => null, "a_image" => $a_z_success . "l.png", "a_extra" => 1, 'a_content' => "l"],


            ['round' => 4, 'game_id' => 260, 'q_audio' =>  $AudioDomain . $G2_L2_trace_word . "boat" . ".mp3", 'q_content' =>  null, 'q_image' => $l2_G260_image . "boat" . ".png", "a_image" => null, "a_extra" => null, 'a_content' => "boat"],
            ['round' => 4, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $A_Z_traceword . "B" . ".png", 'q_image' => null, "a_image" => $A_Z_success . "B.png", "a_extra" => 3, 'a_content' => "B"],
            ['round' => 4, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $a_z_traceword . "o" . ".png", 'q_image' => null, "a_image" => $a_z_success . "o.png", "a_extra" => 1, 'a_content' => "o"],
            ['round' => 4, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $a_z_traceword . "a" . ".png", 'q_image' => null, "a_image" => $a_z_success . "a.png", "a_extra" => 2, 'a_content' => "a"],
            ['round' => 4, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $a_z_traceword . "t" . ".png", 'q_image' => null, "a_image" => $a_z_success . "t.png", "a_extra" => 2, 'a_content' => "t"],


            ['round' => 5, 'game_id' => 260, 'q_audio' =>  $AudioDomain . $G2_L2_trace_word . "boy" . ".mp3", 'q_content' =>  null, 'q_image' => $l2_G260_image . "boy" . ".png", "a_image" => null, "a_extra" => null, 'a_content' => "boy"],
            ['round' => 5, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $A_Z_traceword . "B" . ".png", 'q_image' => null, "a_image" => $A_Z_success . "B.png", "a_extra" => 3, 'a_content' => "B"],
            ['round' => 5, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $a_z_traceword . "o" . ".png", 'q_image' => null, "a_image" => $a_z_success . "o.png", "a_extra" => 1, 'a_content' => "o"],
            ['round' => 5, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $a_z_traceword . "y" . ".png", 'q_image' => null, "a_image" => $a_z_success . "y.png", "a_extra" => 2, 'a_content' => "y"],


            ['round' => 6, 'game_id' => 260, 'q_audio' =>  $AudioDomain . $G2_L2_trace_word . "bear" . ".mp3", 'q_content' =>  null, 'q_image' => $l2_G260_image . "bear" . ".png", "a_image" => null, "a_extra" => null, 'a_content' => "bear"],
            ['round' => 6, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $A_Z_traceword . "B" . ".png", 'q_image' => null, "a_image" => $A_Z_success . "B.png", "a_extra" => 3, 'a_content' => "B"],
            ['round' => 6, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $a_z_traceword . "e" . ".png", 'q_image' => null, "a_image" => $a_z_success . "e.png", "a_extra" => 2, 'a_content' => "e"],
            ['round' => 6, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $a_z_traceword . "a" . ".png", 'q_image' => null, "a_image" => $a_z_success . "a.png", "a_extra" => 2, 'a_content' => "a"],
            ['round' => 6, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $a_z_traceword . "r" . ".png", 'q_image' => null, "a_image" => $a_z_success . "r.png", "a_extra" => 2, 'a_content' => "r"],


            ['round' => 7, 'game_id' => 260, 'q_audio' =>  $AudioDomain . $G2_L2_trace_word . "apple" . ".mp3", 'q_content' =>  null, 'q_image' => $l2_G260_image . "apple" . ".png", "a_image" => null, "a_extra" => null, 'a_content' => "apple"],
            ['round' => 7, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $A_Z_traceword . "A" . ".png", 'q_image' => null, "a_image" => $A_Z_success . "A.png", "a_extra" => 3, 'a_content' => "A"],
            ['round' => 7, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $a_z_traceword . "p" . ".png", 'q_image' => null, "a_image" => $a_z_success . "p.png", "a_extra" => 2, 'a_content' => "p"],
            ['round' => 7, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $a_z_traceword . "p" . ".png", 'q_image' => null, "a_image" => $a_z_success . "p.png", "a_extra" => 2, 'a_content' => "p"],
            ['round' => 7, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $a_z_traceword . "l" . ".png", 'q_image' => null, "a_image" => $a_z_success . "l.png", "a_extra" => 1, 'a_content' => "l"],
            ['round' => 7, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $a_z_traceword . "e" . ".png", 'q_image' => null, "a_image" => $a_z_success . "e.png", "a_extra" => 2, 'a_content' => "e"],

            ['round' => 8, 'game_id' => 260, 'q_audio' =>  $AudioDomain . $G2_L2_trace_word . "ant" . ".mp3", 'q_content' =>  null, 'q_image' => $l2_G260_image . "ant" . ".png", "a_image" => null, "a_extra" => null, 'a_content' => "ant"],
            ['round' => 8, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $A_Z_traceword . "A" . ".png", 'q_image' => null, "a_image" => $A_Z_success . "A.png", "a_extra" => 3, 'a_content' => "A"],
            ['round' => 8, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $a_z_traceword . "n" . ".png", 'q_image' => null, "a_image" => $a_z_success . "n.png", "a_extra" => 2, 'a_content' => "n"],
            ['round' => 8, 'game_id' => 260, 'q_audio' => null, 'q_content' =>  $a_z_traceword . "t" . ".png", 'q_image' => null, "a_image" => $a_z_success . "t.png", "a_extra" => 2, 'a_content' => "t"],
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 263, 'a_image' => $l2_G263image . "jane.gif", "a_audio" => $AudioDomain . $G2_L2_listen_n_speak . "Hello-Im-Jane-I-like-apples.mp3", "a_conver" => $l2_G263image .  "hello-jane-apple.png", "background" =>  $l2_G263image . "bg.png"],
            ['round' => 1, 'game_id' => 263, 'a_image' => $l2_G263image . "rosy.gif", "a_audio" => $AudioDomain . $G2_L2_listen_n_speak . "Hi-Jane-Im-Rosy-I-like-ani.mp3", "a_conver" => $l2_G263image .  "rosy-animal-what.png", "background" =>  $l2_G263image . "bg.png"],
            ['round' => 1, 'game_id' => 263, 'a_image' => $l2_G263image . "chris.gif", "a_audio" => $AudioDomain . $G2_L2_listen_n_speak . "Hello-Rosy-My-names-Chris.mp3", "a_conver" => $l2_G263image .  "chris-banana.png", "background" =>  $l2_G263image . "bg.png"],

            ['round' => 2, 'game_id' => 263, 'a_image' => $l2_G263image . "jane.gif", "a_audio" => $AudioDomain . $G2_L2_listen_n_speak . "Hello-Im-Chris-I-like-angel.mp3", "a_conver" => $l2_G263image .  "chris-angle-what.png", "background" =>  $l2_G263image . "bg.png"],
            ['round' => 2, 'game_id' => 263, 'a_image' => $l2_G263image . "rosy.gif", "a_audio" => $AudioDomain . $G2_L2_listen_n_speak . "SubBlock_Hi-Chris-Im-Jane-I-like-br.mp3", "a_conver" => $l2_G263image .  "jane-bread.png", "background" =>  $l2_G263image . "bg.png"],
            ['round' => 2, 'game_id' => 263, 'a_image' => $l2_G263image . "chris.gif", "a_audio" => $AudioDomain . $G2_L2_listen_n_speak . "Hello-Jane-My-names-Rosy-I.mp3", "a_conver" => $l2_G263image .  "rosy-like-angle-too.png", "background" =>  $l2_G263image . "bg.png"],
        ]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 11, 'game_id' => 265, 'a_image' => $l3_G265_image . "hla.gif", "a_audio" => $AudioDomain . $G2_L3_Speaking . "Hi-Su-Su-How-are-you-feeling.mp3", "a_conver" => $l3_G265_image .  "hi-susu.png", "background" =>  $l3_G265_image . "bg1.png"],

            ['round' => 11, 'game_id' => 265, 'a_image' => $l3_G265_image . "su.gif", "a_audio" => $AudioDomain . $G2_L3_Speaking . "Hello-Hla-Hla-Im-happy.mp3", "a_conver" => $l3_G265_image .  "hello-hla-hla.png", "background" =>  $l3_G265_image . "bg1.png"],

            ['round' => 12, 'game_id' => 265, 'a_image' => $l3_G265_image . "su.gif", "a_audio" => $AudioDomain . $G2_L3_Speaking . "Hi-Aye-Aye-How-are-you-feelin.mp3", "a_conver" => $l3_G265_image .  "hi-aye-aye.png", "background" =>  $l3_G265_image . "bg1.png"],

            ['round' => 12, 'game_id' => 265, 'a_image' => $l3_G265_image . "aye.gif", "a_audio" => $AudioDomain . $G2_L3_Speaking . "Hello-Su-Su-Im-hungry.mp3", "a_conver" => $l3_G265_image .  "hello-susu.png", "background" =>  $l3_G265_image . "bg1.png"],

            ['round' => 13, 'game_id' => 265, 'a_image' => $l3_G265_image . "chris.gif", "a_audio" => $AudioDomain . $G2_L3_Speaking . "Block_Hi-Kyaw-Kyaw-How-are-you-feeli.mp3", "a_conver" => $l3_G265_image .  "hi-kyaw-kyaw.png", "background" =>  $l3_G265_image . "bg1.png"],

            ['round' => 13, 'game_id' => 265, 'a_image' => $l3_G265_image . "kyaw.gif", "a_audio" =>  $AudioDomain . $G2_L3_Speaking . "Block_Hello-Chris-Im-sad.mp3", "a_conver" => $l3_G265_image .  "hello-chris.png", "background" =>  $l3_G265_image . "bg1.png"],
        ]);

        DB::table('ans_n_ques')->insert([
            ['round' => 14, 'game_id' => 265,  'q_image' => $l3_G265_image . "teacher_chara.png", "q_content" => null, "q_conver" => $l3_G265_image . "small_Hello-what-is-your-name.png", "round_instruction" => $AudioDomain . $G2_L3_Speaking . "SubBlock_hello-what-is-your-name-how" . ".mp3"],
        ]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 271, 'a_image' => $l4G271image . "rosy.gif", "a_audio" => $AudioDomain . $G2_L4_speaking . "Hello-Im-Rosy-Im-tired-I.mp3", "a_conver" => $l4G271image . "rosy-text.png", "background" =>  $l4G271image . "bg.jpg"],
            ['round' => 1, 'game_id' => 271, 'a_image' => $l4G271image . "jane.gif", "a_audio" => $AudioDomain . $G2_L4_speaking . "Hi-my-names-Jane-Im-happy.mp3", "a_conver" => $l4G271image . "jane-text.png", "background" =>  $l4G271image . "bg.jpg"],

            ['round' => 2, 'game_id' => 271, 'a_image' => $l4G271image . "jack.gif", "a_audio" => $AudioDomain . $G2_L4_speaking . "Hi-my-names-Jack-Im-hungry.mp3", "a_conver" => $l4G271image . "jack-text.png", "background" =>  $l4G271image . "bg.jpg"],
            ['round' => 2, 'game_id' => 271, 'a_image' => $l4G271image . "rosy.gif", "a_audio" => null, "a_conver" => null, "background" =>  $l4G271image . "bg.jpg"],
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 272, 'a_content' => '943890518', 'isLocal' => 1]);
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 276, 'a_content' => '943893356', 'isLocal' => 1]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 280, "q_audio" => $AudioDomain . $G2_L6_Speaking . "long-hair.mp3", 'q_image' => $l6_G280_image . "long-hair.png", "round_instruction" => $AudioDomain . $G2_L6_Speaking . "Look-at-the-picture-and-say.mp3", "q_content" => "Look at the picture and say."],
            ['round' => 2, 'game_id' => 280, "q_audio" => $AudioDomain . $G2_L6_Speaking . "short-hair.mp3", 'q_image' => $l6_G280_image . "short-hair.png", "round_instruction" => $AudioDomain . $G2_L6_Speaking . "Look-at-the-picture-and-say.mp3", "q_content" => "Look at the picture and say."],
            ['round' => 3, 'game_id' => 280, "q_audio" => $AudioDomain . $G2_L6_Speaking . "Oval-face.mp3", 'q_image' => $l6_G280_image . "oval-face.png", "round_instruction" => $AudioDomain . $G2_L6_Speaking . "Look-at-the-picture-and-say.mp3", "q_content" => "Look at the picture and say."],
            ['round' => 4, 'game_id' => 280, "q_audio" => $AudioDomain . $G2_L6_Speaking . "dark-eyes.mp3", 'q_image' => $l6_G280_image . "dark-eyes.png", "round_instruction" => $AudioDomain . $G2_L6_Speaking . "Look-at-the-picture-and-say.mp3", "q_content" => "Look at the picture and say."],
            ['round' => 5, 'game_id' => 280, "q_audio" => $AudioDomain . $G2_L6_Speaking . "round-face.mp3", 'q_image' => $l6_G280_image . "round-face.png", "round_instruction" => $AudioDomain . $G2_L6_Speaking . "Look-at-the-picture-and-say.mp3", "q_content" => "Look at the picture and say."],
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 286, 'a_image' => $l7G286image . "jane.gif", "a_audio" => $AudioDomain . $G2_L7_speaking . "SubBlock_Hello-Im-Jane-Im-excited.mp3", "a_conver" => $l7G286image . "jane-text.png", "background" =>  $l7G286image . "bg.jpg"],
            ['round' => 1, 'game_id' => 286, 'a_image' => $l7G286image . "chris.gif", "a_audio" => $AudioDomain . $G2_L7_speaking . "Hi-my-names-Chris-Im-happy.mp3", "a_conver" => $l7G286image . "chris-text.png", "background" =>  $l7G286image . "bg.jpg"],

            ['round' => 2, 'game_id' => 286, 'a_image' => $l7G286image . "jack.gif", "a_audio" => $AudioDomain . $G2_L7_speaking . "Hi-my-names-Jack-Im-joyful.mp3", "a_conver" => $l7G286image . "jack-text.png", "background" =>  $l7G286image . "bg.jpg"],
            ['round' => 2, 'game_id' => 286, 'a_image' => $l7G286image . "chris.gif", "a_audio" => null, "a_conver" => null, "background" =>  $l7G286image . "bg.jpg"],
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 287, 'a_content' => '943893472', 'isLocal' => 1]);
        ...
        ////////////////////////////////////////////////////////
        ////    Grade 2  Lesson 8 Game 289 ( writing )
        ////////////////////////////////////////////////////////
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 292, "q_audio" => $AudioDomain . $G2_L8_Speaking . "shorttree.mp3", 'q_image' => $l8_G292_image . "short-tree.png", "round_instruction" => $AudioDomain . $G2_L8_Speaking . "What-is-it.mp3", "q_content" => "What is it?"],
            ['round' => 2, 'game_id' => 292, "q_audio" => $AudioDomain . $G2_L8_Speaking . "bigcup.mp3", 'q_image' => $l8_G292_image . "cup.png", "round_instruction" => $AudioDomain . $G2_L8_Speaking . "What-is-it.mp3", "q_content" => "What is it?"],
            ['round' => 3, 'game_id' => 292, "q_audio" => $AudioDomain . $G2_L8_Speaking . "talltree.mp3", 'q_image' => $l8_G292_image . "tall-tree.png", "round_instruction" => $AudioDomain . $G2_L8_Speaking . "What-is-it.mp3", "q_content" => "What is it?"],
            ['round' => 4, 'game_id' => 292, "q_audio" => $AudioDomain . $G2_L8_Speaking . "thindog.mp3", 'q_image' => $l8_G292_image . "thin-dog.png", "round_instruction" => $AudioDomain . $G2_L8_Speaking . "What-is-it.mp3", "q_content" => "What is it?"],
            ['round' => 5, 'game_id' => 292, "q_audio" => $AudioDomain . $G2_L8_Speaking . "fatdog.mp3", 'q_image' => $l8_G292_image . "fat-dog.png", "round_instruction" => $AudioDomain . $G2_L8_Speaking . "What-is-it.mp3", "q_content" => "What is it?"],
        ...
        DB::table('ans_n_ques')->insert([
            ...
            [
                'round' => 1, 'game_id' => 297, "q_audio" => $AudioDomain . $G2_L9_Speaking . "big-cup-girl.mp3", 'q_image' => $l9_G297_image . "big-cup-girl.png", "round_instruction" => $AudioDomain . $G2_L9_Speaking . "Look-at-the-pictures-and-speak.mp3",
                "q_content" => "Look at the picture and speak. \n Example \n She has a big cup. I like it. \n What about you? Do you like it?"
            ],

            [
                'round' => 2, 'game_id' => 297, "q_audio" => $AudioDomain . $G2_L9_Speaking . "small-cup-boy.mp3", 'q_image' => $l9_G297_image . "small-cup-boy.png", "round_instruction" => $AudioDomain . $G2_L9_Speaking . "Look-at-the-pictures-and-speak.mp3",
                "q_content" => "Look at the picture and speak. \n Example \n He has a small cup. I do not like it. \n What about you? Do you like it?"
            ],


            ['round' => 3, 'game_id' => 297, "q_audio" => $AudioDomain . $G2_L9_Speaking . "girl-dog.mp3", 'q_image' => $l9_G297_image . "girl-dog.png", "round_instruction" => $AudioDomain . $G2_L9_Speaking . "Look-at-the-pictures-and-speak.mp3", "q_content" => "Look at the picture and speak."],

            ['round' => 4, 'game_id' => 297, "q_audio" => $AudioDomain . $G2_L9_Speaking . "boy-dog.mp3", 'q_image' => $l9_G297_image . "boy-dog.png", "round_instruction" => $AudioDomain . $G2_L9_Speaking . "Look-at-the-pictures-and-speak.mp3", "q_content" => "Look at the picture and speak."],

            ['round' => 5, 'game_id' => 297, "q_audio" => $AudioDomain . $G2_L9_Speaking . "farm-girl.mp3", 'q_image' => $l9_G297_image . "farm-girl.png", "round_instruction" => $AudioDomain . $G2_L9_Speaking . "Look-at-the-pictures-and-speak.mp3", "q_content" => "Look at the picture and speak."],

            ['round' => 6, 'game_id' => 297, "q_audio" => $AudioDomain . $G2_L9_Speaking . "hat-boy.mp3", 'q_image' => $l9_G297_image . "hat-boy.png", "round_instruction" => $AudioDomain . $G2_L9_Speaking . "Look-at-the-pictures-and-speak.mp3", "q_content" => "Look at the picture and speak."],

            ['round' => 7, 'game_id' => 297, "q_audio" => $AudioDomain . $G2_L9_Speaking . "big-house.mp3", 'q_image' => $l9_G297_image . "big-house.png", "round_instruction" => $AudioDomain . $G2_L9_Speaking . "Look-at-the-pictures-and-speak.mp3", "q_content" => "Look at the picture and speak."],

            ['round' => 8, 'game_id' => 297, "q_audio" => $AudioDomain . $G2_L9_Speaking . "small-house.mp3", 'q_image' => $l9_G297_image . "small-house.png", "round_instruction" => $AudioDomain . $G2_L9_Speaking . "Look-at-the-pictures-and-speak.mp3", "q_content" => "Look at the picture and speak."],
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 298, 'a_content' => '943899975', 'isLocal' => 1]);
        ...
        for ($i = 0; $i < count($ansL10_G299); $i++) {
            for ($j = 0; $j < count($ansL10_G299[$i]); $j++) {
                DB::table('ans_n_ques')->insert([
                    [
                        'game_id' => 299,
                        'a_content' =>  $ansL10_G299[$i][$j],
                        'a_image' => $l10_G299_image . $ansL10_G299[$i][$j] . ".png",
                        'a_audio' => $AudioDomain . $G2_L10_listen_n_repeat . strtolower($ansL10_G299[$i][$j]) . ".mp3",
                        'q_content' => $i,
                    ],
                ]);
            }
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 301, "q_audio" => $AudioDomain . $G2_L10_Speaking . "houses.mp3", 'q_image' => $l10_G301_image . "houses.png", "round_instruction" => $AudioDomain . $G2_L10_Speaking . "Look-at-the-pictures-and-speak.mp3", "q_content" => " Example \n My house is new. Your house in old."],

            ['round' => 2, 'game_id' => 301, "q_audio" => $AudioDomain . $G2_L10_Speaking . "haris.mp3", 'q_image' => $l10_G301_image . "hairs.png", "round_instruction" => $AudioDomain . $G2_L10_Speaking . "Look-at-the-pictures-and-speak.mp3", "q_content" => " Example \n Her hair is long. His hair is short."],


            ['round' => 3, 'game_id' => 301, "q_audio" => $AudioDomain . $G2_L10_Speaking . "lessons.mp3", 'q_image' => $l10_G301_image . "lessons.png", "round_instruction" => $AudioDomain . $G2_L10_Speaking . "Look-at-the-pictures-and-speak.mp3", "q_content" => "Look at the picture and speak."],

            ['round' => 4, 'game_id' => 301, "q_audio" => $AudioDomain . $G2_L10_Speaking . "pencils.mp3", 'q_image' => $l10_G301_image . "pencils.png", "round_instruction" => $AudioDomain . $G2_L10_Speaking . "Look-at-the-pictures-and-speak.mp3", "q_content" => "Look at the picture and speak."],

            ['round' => 5, 'game_id' => 301, "q_audio" => $AudioDomain . $G2_L10_Speaking . "jackets.mp3", 'q_image' => $l10_G301_image . "jackets.png", "round_instruction" => $AudioDomain . $G2_L10_Speaking . "Look-at-the-pictures-and-speak.mp3", "q_content" => "Look at the picture and speak."],

            ['round' => 6, 'game_id' => 301, "q_audio" => $AudioDomain . $G2_L10_Speaking . "bags.mp3", 'q_image' => $l10_G301_image . "bags.png", "round_instruction" => $AudioDomain . $G2_L10_Speaking . "Look-at-the-pictures-and-speak.mp3", "q_content" => "Look at the picture and speak."],

            ['round' => 7, 'game_id' => 301, "q_audio" => $AudioDomain . $G2_L10_Speaking . "drinks.mp3", 'q_image' => $l10_G301_image . "drinks.png", "round_instruction" => $AudioDomain . $G2_L10_Speaking . "Look-at-the-pictures-and-speak.mp3", "q_content" => "Look at the picture and speak."],
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 3, 'game_id' => 303, "q_audio" => $AudioDomain . $G2_L11_Speaking . "hat.mp3", 'q_image' => $l11_G303_image . "hat.png", "round_instruction" => $AudioDomain . $G2_L11_Speaking . "Look-at-the-pictures-and-speak.mp3", "q_content" => "Look at the picture and speak."],

            ['round' => 4, 'game_id' => 303, "q_audio" => $AudioDomain . $G2_L11_Speaking . "jacket.mp3", 'q_image' => $l11_G303_image . "jacket.png", "round_instruction" => $AudioDomain . $G2_L11_Speaking . "Look-at-the-pictures-and-speak.mp3", "q_content" => "Look at the picture and speak."],

            ['round' => 5, 'game_id' => 303, "q_audio" => $AudioDomain . $G2_L11_Speaking . "boat.mp3", 'q_image' => $l11_G303_image . "boat.png", "round_instruction" => $AudioDomain . $G2_L11_Speaking . "Look-at-the-pictures-and-speak.mp3", "q_content" => "Look at the picture and speak."],

            ['round' => 6, 'game_id' => 303, "q_audio" => $AudioDomain . $G2_L11_Speaking . "bicycle.mp3", 'q_image' => $l11_G303_image . "bicycle.png", "round_instruction" => $AudioDomain . $G2_L11_Speaking . "Look-at-the-pictures-and-speak.mp3", "q_content" => "Look at the picture and speak."],
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 304, 'a_content' => '943901032', 'isLocal' => 1]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 307, "q_audio" => $AudioDomain . $G2_L12_Speaking . "fish.mp3", 'q_image' => $l12_G307_image . "fish.png", "round_instruction" => $AudioDomain . $G2_L12_Speaking . "Look-at-the-pictures-and-speak.mp3", "q_content" => "Look at the picture and speak."],
            ['round' => 2, 'game_id' => 307, "q_audio" => $AudioDomain . $G2_L12_Speaking . "vege.mp3", 'q_image' => $l12_G307_image . "salad.png", "round_instruction" => $AudioDomain . $G2_L12_Speaking . "Look-at-the-pictures-and-speak.mp3", "q_content" => "Look at the picture and speak."],
            ['round' => 3, 'game_id' => 307, "q_audio" => $AudioDomain . $G2_L12_Speaking . "bread.mp3", 'q_image' => $l12_G307_image . "bread.png", "round_instruction" => $AudioDomain . $G2_L12_Speaking . "Look-at-the-pictures-and-speak.mp3", "q_content" => "Look at the picture and speak."],
            ['round' => 4, 'game_id' => 307, "q_audio" => $AudioDomain . $G2_L12_Speaking . "milk.mp3", 'q_image' => $l12_G307_image . "milk.png", "round_instruction" => $AudioDomain . $G2_L12_Speaking . "Look-at-the-pictures-and-speak.mp3", "q_content" => "Look at the picture and speak."],
            ['round' => 5, 'game_id' => 307, "q_audio" => $AudioDomain . $G2_L12_Speaking . "meat.mp3", 'q_image' => $l12_G307_image . "meat.png", "round_instruction" => $AudioDomain . $G2_L12_Speaking . "Look-at-the-pictures-and-speak.mp3", "q_content" => "Look at the picture and speak."],
            ['round' => 6, 'game_id' => 307, "q_audio" => $AudioDomain . $G2_L12_Speaking . "banana.mp3", 'q_image' => $l12_G307_image . "fruit.png", "round_instruction" => $AudioDomain . $G2_L12_Speaking . "Look-at-the-pictures-and-speak.mp3", "q_content" => "Look at the picture and speak."],
            ['round' => 7, 'game_id' => 307, "q_audio" => $AudioDomain . $G2_L12_Speaking . "sandwich.mp3", 'q_image' => $l12_G307_image . "vege.png", "round_instruction" => $AudioDomain . $G2_L12_Speaking . "Look-at-the-pictures-and-speak.mp3", "q_content" => "Look at the picture and speak."],
            ['round' => 8, 'game_id' => 307, "q_audio" => $AudioDomain . $G2_L12_Speaking . "fried-rice.mp3", 'q_image' => $l12_G307_image . "rice.png", "round_instruction" => $AudioDomain . $G2_L12_Speaking . "Look-at-the-pictures-and-speak.mp3", "q_content" => "Look at the picture and speak."],
        ...
        DB::table('ans_n_ques')->insert([
            ...
            [
                'round' => 1, 'game_id' => 313, "q_audio" => $AudioDomain . $G2_L13_Speaking . "I-like-ice-what-about-you.mp3", 'q_image' => $l13_G313_image . "ice-cream.png", "round_instruction" => $AudioDomain . $G2_L13_Speaking . "look-at-the-picture-and-answer-the-question" . ".mp3",
                "q_content" => "Look at the picture and answer the question.\n Example \n I like ice cream. What about you? \n I like ice cream too."
            ],

            [
                'round' => 2, 'game_id' => 313, "q_audio" => $AudioDomain . $G2_L13_Speaking . "I-like-jam.mp3", 'q_image' => $l13_G313_image . "jam.png", "round_instruction" => $AudioDomain . $G2_L13_Speaking . "look-at-the-picture-and-answer-the-question" . ".mp3",
                "q_content" => "Look at the picture and answer the question.\n Example \n Do you like jam.? \n Yes, I do. I like it very much"
            ],

            [
                'round' => 3, 'game_id' => 313, "q_audio" => $AudioDomain . $G2_L13_Speaking . "I-like-juice-what-about-you.mp3", 'q_image' => $l13_G313_image . "juice.png", "round_instruction" => $AudioDomain . $G2_L13_Speaking . "look-at-the-picture-and-answer-the-question" . ".mp3",
                "q_content" => "Look at the picture and answer the question.\n Example \n I like juice. What about you? \n I don't like it."
            ],

            [
                'round' => 4, 'game_id' => 313, "q_audio" => $AudioDomain . $G2_L13_Speaking . "I-like-jacket.mp3", 'q_image' => $l13_G313_image . "jacket.png", "round_instruction" => $AudioDomain . $G2_L13_Speaking . "look-at-the-picture-and-answer-the-question" . ".mp3",
                "q_content" => "Look at the picture and answer the question.\n Example \n Is this your jacket? \n No, is isn't. It is his jacket. \n Is it white? \n Yes, it is."
            ],


            ['round' => 5, 'game_id' => 313, "q_audio" => $AudioDomain . $G2_L13_Speaking . "I-like-igloo-what-about-you.mp3", 'q_image' => $l13_G313_image . "igloo.png", "round_instruction" => $AudioDomain . $G2_L13_Speaking . "look-at-the-picture-and-answer-the-question.mp3", "q_content" => "Look at the picture and answer the question.\n I like igloo. What about you?"],

            ['round' => 6, 'game_id' => 313, "q_audio" => $AudioDomain . $G2_L13_Speaking . "do-you-like-jelly.mp3", 'q_image' => $l13_G313_image . "jelly.png", "round_instruction" => $AudioDomain . $G2_L13_Speaking . "look-at-the-picture-and-answer-the-question.mp3", "q_content" => "Look at the picture and answer the question.\n Do you like jelly? \nYes, I do. I like it very much."],

            ['round' => 7, 'game_id' => 313, "q_audio" => $AudioDomain . $G2_L13_Speaking . "I-like-june-what-about-you.mp3", 'q_image' => $l13_G313_image . "june.png", "round_instruction" => $AudioDomain . $G2_L13_Speaking . "look-at-the-picture-and-answer-the-question.mp3", "q_content" => "Look at the picture and answer the question.\n I like June. What about you?"],

            ['round' => 8, 'game_id' => 313, "q_audio" => $AudioDomain . $G2_L13_Speaking . "I-dont-like-july-what-about-you.mp3", 'q_image' => $l13_G313_image . "july.png", "round_instruction" => $AudioDomain . $G2_L13_Speaking . "look-at-the-picture-and-answer-the-question.mp3", "q_content" => "Look at the picture and answer the question.\n I don't like July. What about you?"],

            ['round' => 9, 'game_id' => 313, "q_audio" => $AudioDomain . $G2_L13_Speaking . "do-you-like-jacket.mp3", 'q_image' => $l13_G313_image . "brown-jacket.png", "round_instruction" => $AudioDomain . $G2_L13_Speaking . "look-at-the-picture-and-answer-the-question.mp3", "q_content" => "Look at the picture and answer the question.\n Do you like this jacket? \nYes, i do. It is beautiful."],

            ['round' => 10, 'game_id' => 313, "q_audio" => $AudioDomain . $G2_L13_Speaking . "do-you-like-insects.mp3", 'q_image' => $l13_G313_image . "insects.png", "round_instruction" => $AudioDomain . $G2_L13_Speaking . "look-at-the-picture-and-answer-the-question.mp3", "q_content" => "Look at the picture and answer the question.\n Do you like insects? \nNo, I don't. I hate them."],

            ['round' => 11, 'game_id' => 313, "q_audio" => $AudioDomain . $G2_L13_Speaking . "do-you-like-insects.mp3", 'q_image' => $l13_G313_image . "insects.png", "round_instruction" => $AudioDomain . $G2_L13_Speaking . "look-at-the-picture-and-answer-the-question.mp3", "q_content" => "Look at the picture and answer the question.\n Do you like insects? \nNo, I don't. I hate them."],

            ['round' => 12, 'game_id' => 313, "q_audio" => $AudioDomain . $G2_L13_Speaking . "do-you-like-insects.mp3", 'q_image' => $l13_G313_image . "insects.png", "round_instruction" => $AudioDomain . $G2_L13_Speaking . "look-at-the-picture-and-answer-the-question.mp3", "q_content" => "Look at the picture and answer the question.\n Do you like insects? \nNo, I don't. I hate them."],

            ['round' => 13, 'game_id' => 313, "q_audio" => $AudioDomain . $G2_L13_Speaking . "is-it-orange.mp3", 'q_image' => $l13_G313_image . "bag.png", "round_instruction" => $AudioDomain . $G2_L13_Speaking . "look-at-the-picture-and-answer-the-question.mp3", "q_content" => "Look at the picture and answer the question.\n Is it orange?"],

            ['round' => 14, 'game_id' => 313, "q_audio" => $AudioDomain . $G2_L13_Speaking . "is-it-brown.mp3", 'q_image' => $l13_G313_image . "pencil.png", "round_instruction" => $AudioDomain . $G2_L13_Speaking . "look-at-the-picture-and-answer-the-question.mp3", "q_content" => "Look at the picture and answer the question.\n Is is brown?"],
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 315, 'a_content' => '943901112', 'isLocal' => 1]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 318, 'a_image' => $l14_G318_image . "boy.gif", "a_audio" => $AudioDomain . $G2_L14_speak . "SubBlock_Whats-your-favorite-food.mp3", "a_conver" =>  $l14_G318_image . "fav-food-text.png", "background" =>  $l14_G318_image . "bg.jpg"],
            ['round' => 1, 'game_id' => 318, 'a_image' => $l14_G318_image . "girl.gif", "a_audio" => $AudioDomain . $G2_L14_speak . "SubBlock_My-favorite-food-is-fried-nood.mp3", "a_conver" =>  $l14_G318_image . "fav-noodle-text.png", "background" =>  $l14_G318_image . "bg.jpg"],

            ['round' => 2, 'game_id' => 318, 'a_image' => $l14_G318_image . "girl.gif", "a_audio" => $AudioDomain . $G2_L14_speak . "SubBlock_What-about-you.mp3", "a_conver" =>  $l14_G318_image . "what-about-text.png", "background" =>  $l14_G318_image . "bg.jpg"],
            ['round' => 2, 'game_id' => 318, 'a_image' => $l14_G318_image . "boy.gif", "a_audio" => $AudioDomain . $G2_L14_speak . "SubBlock_it-is-hamburger.mp3", "a_conver" =>  $l14_G318_image . "hambur.png", "background" =>  $l14_G318_image . "bg.jpg"],

        ]);

        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 319, "q_audio" => $AudioDomain . $G2_L14_speak . "Strawberry-juice-or-orange-jui.mp3", 'q_image' => $l14_G318_image . "juice.png", "q_content" => "What's your favorite juice?", "round_instruction" => $AudioDomain . $G2_L14_speak . "Whats-your-favorite-juice.mp3"],
            ['round' => 2, 'game_id' => 319, "q_audio" => $AudioDomain . $G2_L14_speak . "Wafers-or-pudding.mp3", 'q_image' => $l14_G318_image . "food.png", "q_content" => "What's your favorite food?", "round_instruction" => $AudioDomain . $G2_L14_speak . "Whats-your-favorite-food.mp3"],
            ['round' => 3, 'game_id' => 319, "q_audio" => $AudioDomain . $G2_L14_speak . "SubBlock_Banana-cake-or-Cheese-cake.mp3", 'q_image' => $l14_G318_image . "cake.png", "q_content" => "What's your favorite food?", "round_instruction" => $AudioDomain . $G2_L14_speak . "Whats-your-favorite-food.mp3"],
            ['round' => 4, 'game_id' => 319, "q_audio" => $AudioDomain . $G2_L14_speak . "Strawberry-or-pineapple.mp3", 'q_image' => $l14_G318_image . "straw.png", "q_content" => "What's your favorite fruit?", "round_instruction" => $AudioDomain . $G2_L14_speak . "Whats-your-favorite-fruit.mp3"],
        ]);
        ...
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 325,  'q_image' => $l15_G325_image . "green_starfish.png", "q_audio" => $AudioDomain . $G2_L15_Speaking . "My-names-Chris-I-have-a-frie.mp3", "q_content" => "My name's _____. I have a _______. His/her name's ______. She has a ______  kite. _____ and I like kites. They are ______  and _______. We fly kites in the ______ . We are ______ when we fly kites. "],
        ]);
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 327, 'a_content' => '943905944', 'isLocal' => 1]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 331, "q_audio" => $AudioDomain . $G2_L16_Speaking . "What-day-is-it-today.mp3", 'q_image' => $l16_G331_image . "sat.png", "round_instruction" => $AudioDomain . $G2_L16_Speaking . "Look-at-the-pictures-and-speak.mp3", "q_content" => "Look at the picture and speak \n Example \n What day is it today? \n It's Saturday."],

            ['round' => 2, 'game_id' => 331, "q_audio" => $AudioDomain . $G2_L16_Speaking . "favorite-day-of-the-week.mp3", 'q_image' => $l16_G331_image . "sun.png", "round_instruction" => $AudioDomain . $G2_L16_Speaking . "Look-at-the-pictures-and-speak.mp3", "q_content" => "Look at the picture and speak \n Example \n What's your favorite day of the week? It's Sunday."],
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 332, 'a_content' => '943905790', 'isLocal' => 1]);
        ...
        DB::table('ans_n_ques')->insert([
            [
                'round' => 1, 'game_id' => 335, "q_audio" => $AudioDomain . $G2_L17_Speaking . "My-best-friend-is-Jack-He-lik" . ".mp3", 'q_image' => $l17_G335_image . "boy.png",
                "q_content" => "My best friend is _____. He/She likes _____. On Monday, he/she eats ______ ______. On Tuesday, he/she eats _____ ______. On Wednesday, he/she eats _____ _____. On Thursday, he/she eats _____ ______. On Friday, he/she drinks _____ _____. On Saturday, he/she eats _____ ______. He/She likes it very much. On Sunday, he/she is sick."
            ],
        ]);
        ...
        DB::table('ans_n_ques')->insert(['game_id' => 336, 'a_content' => '943905899', 'isLocal' => 1]);
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 338, "q_audio" => $AudioDomain . $G2_L18_Speaking . "SubBlock_He-can-dance.mp3", 'q_image' => $l18_G338_image . "dance.png", "round_instruction" => $AudioDomain . $G2_L18_Speaking . "can-he-dance.mp3", "q_content" => "Look at the picture and speak. \n Example \n Can he dance? \n Yes, he can."],
            ...
            ['round' => 4, 'game_id' => 338, "q_audio" => $AudioDomain . $G2_L18_Speaking . "they-can-jump.mp3", 'q_image' => $l18_G338_image . "jump.png", "round_instruction" => $AudioDomain . $G2_L18_Speaking . "can-they-jump.mp3", "q_content" => "Can they jump?"],
        ...
        DB::table('ans_n_ques')->insert([
            ...
            ['round' => 1, 'game_id' => 345, 'a_image' => $l19_G345_G346_image . "left.gif", "a_audio" => $AudioDomain . $G2_L19_speak . "SubBlock_Can-you-draw-mango.mp3", "a_conver" => $l19_G345_G346_image . "q-mango.png", "background" =>  $l19_G345_G346_image . "bg.png"],
            ['round' => 1, 'game_id' => 345, 'a_image' => $l19_G345_G346_image . "right.gif", "a_audio" => $AudioDomain . $G2_L19_speak . "SubBlock_Yes-i-can-what-about-you.mp3", "a_conver" => $l19_G345_G346_image . "yes-i-can.png", "background" =>  $l19_G345_G346_image . "bg.png"],

            ['round' => 2, 'game_id' => 345, 'a_image' => $l19_G345_G346_image . "left.gif", "a_audio" => $AudioDomain . $G2_L19_speak . "SubBlock_I-can-draw-mango-too.mp3", "a_conver" => $l19_G345_G346_image . "i-can-too.png", "background" =>  $l19_G345_G346_image . "bg.png"],
            ['round' => 2, 'game_id' => 345, 'a_image' => $l19_G345_G346_image . "right.gif", "a_audio" => null, "a_conver" => null, "background" =>  $l19_G345_G346_image . "bg.png"],

        ]);

        // game 346
        DB::table('ans_n_ques')->insert([
            ['round' => 1, 'game_id' => 346,  "q_audio" => $AudioDomain . $G2_L19_speak . "Can-you-draw-nose.mp3", 'q_image' => $l19_G345_G346_image . "nose.png", "q_content" => "Can you draw nose?", "round_instruction" => $AudioDomain . $G2_L19_speak . "Can-you-draw-nose" . ".mp3"],
            ['round' => 2, 'game_id' => 346,  "q_audio" => $AudioDomain . $G2_L19_speak . "Do-you-like-magic.mp3", 'q_image' => $l19_G345_G346_image . "magic.png", "q_content" => "Do you like magic?", "round_instruction" => $AudioDomain . $G2_L19_speak . "Do-you-like-magic" . ".mp3"],
            ['round' => 3, 'game_id' => 346,  "q_audio" => $AudioDomain . $G2_L19_speak . "Can-you-draw-nest.mp3", 'q_image' => $l19_G345_G346_image . "nest.png", "q_content" => "Can you draw nest?", "round_instruction" => $AudioDomain . $G2_L19_speak . "Can-you-draw-nest" . ".mp3"],
            ['round' => 4, 'game_id' => 346,  "q_audio" => $AudioDomain . $G2_L19_speak . "Do-you-like-necklace.mp3", 'q_image' => $l19_G345_G346_image . "necklace.png", "q_content" => "Do you like nacklace?", "round_instruction" => $AudioDomain . $G2_L19_speak . "Do-you-like-necklace" . ".mp3"],
        ]);
