...
class UnitSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('units')->insert([
            ...
            ['name' => 'Writing', 'lesson_id' => 12, 'category_id' => 26], //(temporary_id)
            ...
            ['name' => 'Listen, Reading and Repeat', 'lesson_id' => 15, 'category_id' => 26], // temporary
            ['name' => 'Listen and Practice', 'lesson_id' => 15, 'category_id' => 26], // temporary
            ...
            ['name' => 'Speaking', 'lesson_id' => 16, 'category_id' => 26], // temporary
            ['name' => 'Writing', 'lesson_id' => 16, 'category_id' => 26], // temporary

            // // lesson 17's units

            ['name' => 'Target Language', 'lesson_id' => 17, 'category_id' => 1],
            ['name' => 'Listen and Repeat Reading', 'lesson_id' => 17, 'category_id' => 26],//(temporary_id)
            ...
            ['name' => 'Speaking', 'lesson_id' => 20, 'category_id' => 26], // temporary_id
            ['name' => 'Writing', 'lesson_id' => 20, 'category_id' => 26], // temporary_id

            // // lesson 21's games

            ['name' => 'Target Language', 'lesson_id' => 21, 'category_id' => 1],
            ['name' => 'Listen and Repeat Reading', 'lesson_id' => 21, 'category_id' => 26], // temporary_id
            ...
            ['name' => 'Listen and Repeat Reading', 'lesson_id' => 22, 'category_id' => 26], // temporary_id
            ...
            ['name' => 'Listen and Repeat Reading 1', 'lesson_id' => 23, 'category_id' => 26 ], // temporary_id
            ...
            ['name' => 'Reading', 'lesson_id' => 24, 'category_id' => 26 ],    // temporary_id
            ...
            ['name' => 'Listen and Repeat', 'lesson_id' => 25, 'category_id' => 26 ],        // temporary_id
            ...
            ['name' => 'Writing', 'lesson_id' => 25, 'category_id' => 26 ],  // temporary_id

            // // lesson 26's games

            ['name' => 'Target Language & Grammar Explanation', 'lesson_id' => 26, 'category_id' => 1],
            ['name' => 'Read, Listen and Repeat Reading 1', 'lesson_id' => 26, 'category_id' => 26],      // temporary_id
            ...
            ['name' => 'Speaking 1', 'lesson_id' => 26, 'category_id' => 26],    // temporary_id

            // // lesson 27's games

            ['name' => 'Target Language & Grammar Explanation', 'lesson_id' => 27, 'category_id' => 1],
            ['name' => 'Read, Listen and Repeat', 'lesson_id' => 27, 'category_id' => 26 ],      // temporary_id
            ['name' => 'Listen and Practice Game', 'lesson_id' => 27, 'category_id' => 17],
            ['name' => 'Matching', 'lesson_id' => 27, 'category_id' => 26],      // temporary_id
            ['name' => 'Speaking', 'lesson_id' => 27, 'category_id' => 26],      // temporary_id
            ['name' => 'Writing', 'lesson_id' => 27, 'category_id' => 14],

            // // lesson 28's games

            ['name' => 'Target Language & Grammar Explanation', 'lesson_id' => 28, 'category_id' => 1],
            ['name' => 'Read, Listen and Repeat Reading', 'lesson_id' => 28, 'category_id' => 26 ],    // temporary_id
            ...
            ['name' => 'Speaking', 'lesson_id' => 28, 'category_id' => 26 ],    // temporary_id

            // // lesson 29's games

            ['name' => 'Target Language', 'lesson_id' => 29, 'category_id' => 1],
            ['name' => 'Listen and Repeat Reading', 'lesson_id' => 29, 'category_id' => 26 ],  // temporary_id
            ...
            ['name' => 'Matching', 'lesson_id' => 30, 'category_id' => 26],  // temporary_id
            ['name' => 'Speaking', 'lesson_id' => 30, 'category_id' => 26],   // temporary_id
            ['name' => 'Writing', 'lesson_id' => 30, 'category_id' => 26], // temporary_id

            // // lesson 31's games

            ['name' => 'Target Language', 'lesson_id' => 31, 'category_id' => 1 ],
            ['name' => 'Listen and Repeat', 'lesson_id' => 31, 'category_id' => 2 ],
            ['name' => 'Listen and Practice', 'lesson_id' => 31, 'category_id' => 26 ],  // temporary_id
            ['name' => 'Matching', 'lesson_id' => 31, 'category_id' => 7 ],
            ['name' => 'Speaking', 'lesson_id' => 31, 'category_id' => 11 ],
            ['name' => 'Writing', 'lesson_id' => 31, 'category_id' => 26 ],  // temporary_id


            // // lesson 32's games

            ['name' => 'Target Language', 'lesson_id' => 32, 'category_id' => 1],
            ['name' => 'Listen and Repeat', 'lesson_id' => 32, 'category_id' => 2],    //   temporary_id
            ['name' => 'Listen and Practice', 'lesson_id' => 32, 'category_id' => 17],   // temporary_id
            ...
            ['name' => 'Writing', 'lesson_id' => 36, 'category_id' => 26 ],  //  temporary_id
            ...
            ['name' => 'Read, Listen and Repeat', 'lesson_id' => 38, 'category_id' => 2],      //  temporary_id
            ...
            ['name' => 'Listen and Repeat Reading', 'lesson_id' => 39, 'category_id' => 26 ],    //  temporary_id
            ['name' => 'Listen and Practice', 'lesson_id' => 39, 'category_id' => 26],  //  temporary_id
            ['name' => 'Grammar', 'lesson_id' => 39, 'category_id' => 21],
            ['name' => 'Writing (Arranging order)', 'lesson_id' => 39, 'category_id' => 14],
            ['name' => 'Speaking', 'lesson_id' => 39, 'category_id' => 26 ],  //  temporary_id

            // lesson 40's games

            ['name' => 'Target Language', 'lesson_id' => 40, 'category_id' => 1],
            ['name' => 'Listen and Repeat', 'lesson_id' => 40, 'category_id' => 26 ],   //  temporary_id
