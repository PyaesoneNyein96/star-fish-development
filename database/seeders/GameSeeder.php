...
class GameSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('games')->insert([
            ...
            ['name' => 'Read Listen and Repeat', 'unit_id' => 13],
        ...
        DB::table('games')->insert([
            ...
            ['name' => 'Listening & Practice', 'unit_id' => 20 ],
            ['name' => 'Writing (Arranging Order)', 'unit_id' => 21,],
        ...
        DB::table('games')->insert([
            ...
            ['name' => 'Target Language & Grammar Explanation', 'unit_id' => 34, 'category' =>1],
            ['name' => 'Read, Listen and Repeat', 'unit_id' => 35,'category' =>2],
            ...
            ['name' => 'Writing 2', 'unit_id' => 39, 'category' => "fill_in_the_blanks"],
        ...
        DB::table('games')->insert([
            ...
            ['name' => 'Target Language', 'unit_id' => 65, 'category' => 1],
            ['name' => 'Reading', 'unit_id' => 66, 'category' => 2],
            ['name' => 'Listen and Practice', 'unit_id' => 67, 'category' => 17],
            ['name' => 'Matching', 'unit_id' => 68, 'category' => 7],
            ['name' => 'Speaking Practice', 'unit_id' => 69, 'category' => 11],
        ...
        DB::table('games')->insert([
            ...
            ['name' => 'Target Language & Grammar Explanation', 'unit_id' => 70, ],
            ['name' => 'Reading, Listen and Repeat', 'unit_id' => 13, ],
            ['name' => 'Drag and Drop', 'unit_id' => 13, ],
            ['name' => 'Listen and Practice', 'unit_id' => 13, ],
            ['name' => 'Speaking Practice', 'unit_id' => 13,],
        ]);

        // // lesson 14's games
        DB::table('games')->insert([

            ['name' => 'Target Language & Grammar Explanation', 'unit_id' => 14, ],
            ['name' => 'Reading, Listen and Repeat', 'unit_id' => 14, ],
            ['name' => 'Listen and Practice', 'unit_id' => 14, ],
            ['name' => 'Grammar', 'unit_id' => 14, ],
            ['name' => 'Writing', 'unit_id' => 14, ],
            ['name' => 'Speaking Practice', 'unit_id' => 14,],
        ...
        DB::table('games')->insert([
            ...
            ['name' => 'Target Language & Grammar Explanation', 'unit_id' => 16, 'category' => null],
            ['name' => 'Reading, Listen and Repeat', 'unit_id' => 16, 'category' => null],
            ['name' => 'Listen and Practice, Game', 'unit_id' => 16, 'category' => null],
            ['name' => 'Matching', 'unit_id' => 16, 'category' => null],

            ['name' => 'Speaking 1', 'unit_id' => 16, 'category' => "speaking_and_recording"],
            ['name' => 'Speaking 2', 'unit_id' => 16, 'category' => "speaking_and_recording"],
            ['name' => 'Writing 1', 'unit_id' => 16, 'category' => "letter_tracing"],
            ['name' => 'Writing 2', 'unit_id' => 16, 'category' => "fill_in_the_blanks"],
        ...
        DB::table('games')->insert([
            ...
            ['name' => 'Target Language', 'unit_id' => 17, 'category' => null],

            ['name' => 'Reading 1', 'unit_id' => 95, 'category' => "reading_diagram"],
            ['name' => 'Reading 2', 'unit_id' => 95, 'category' => "reading_carousel"],

            ['name' => 'Listen and Practice', 'unit_id' => 17, 'category' => null],
            ['name' => 'Matching', 'unit_id' => 17, 'category' => null],
            ['name' => 'Listen and Act', 'unit_id' => 17, 'category' => null],
            ['name' => 'Speaking Practice', 'unit_id' => 17, 'category' => null],
