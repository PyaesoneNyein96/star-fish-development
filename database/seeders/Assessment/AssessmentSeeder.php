...
class AssessmentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $game = [
            ["Arranging Letters", "Fill in the blank", "Listening (Drag and Drop)", "Reading Passages", "True or False"],
        ...
        for ($i = 1; $i <= 12; $i++) {
            for ($j = 1; $j <= 5; $j++) {
                foreach ($game[$j - 1] as $val) {
                    DB::table('assessments')->insert([
                        ['grade_id' => $i, "name" => $j, "assess_game_name" => $val, "assess_category_id" => 1]
                    ]);
                }
            }
        }
